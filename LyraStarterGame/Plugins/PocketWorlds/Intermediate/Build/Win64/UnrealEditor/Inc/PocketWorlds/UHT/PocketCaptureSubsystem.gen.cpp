...
// End Cross Module References
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::NewProp_PocketCaptureClass = { "PocketCaptureClass", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(PocketCaptureSubsystem_eventCreateThumbnailRenderer_Parms, PocketCaptureClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UPocketCapture_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(PocketCaptureSubsystem_eventCreateThumbnailRenderer_Parms, ReturnValue), Z_Construct_UClass_UPocketCapture_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPocketCaptureSubsystem, nullptr, "CreateThumbnailRenderer", nullptr, nullptr, sizeof(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::PocketCaptureSubsystem_eventCreateThumbnailRenderer_Parms), Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer_Statics::Function_MetaDataParams)) };
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::NewProp_ThumbnailRenderer = { "ThumbnailRenderer", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(PocketCaptureSubsystem_eventDestroyThumbnailRenderer_Parms, ThumbnailRenderer), Z_Construct_UClass_UPocketCapture_NoRegister, METADATA_PARAMS(nullptr, 0) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPocketCaptureSubsystem, nullptr, "DestroyThumbnailRenderer", nullptr, nullptr, sizeof(Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::PocketCaptureSubsystem_eventDestroyThumbnailRenderer_Parms), Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPocketCaptureSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPocketCaptureSubsystem_CreateThumbnailRenderer, "CreateThumbnailRenderer" }, // 580327162
		{ &Z_Construct_UFunction_UPocketCaptureSubsystem_DestroyThumbnailRenderer, "DestroyThumbnailRenderer" }, // 2531436235
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UPocketCaptureSubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UPocketCaptureSubsystem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UPocketCaptureSubsystem_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPocketCaptureSubsystem, UPocketCaptureSubsystem::StaticClass, TEXT("UPocketCaptureSubsystem"), &Z_Registration_Info_UClass_UPocketCaptureSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPocketCaptureSubsystem), 1210770766U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h_2675395487(TEXT("/Script/PocketWorlds"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_PocketWorlds_Source_Public_PocketCaptureSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
