...
void UManaComponent::InitializeWithAbilitySystem(ULyraAbilitySystemComponent* InASC)
{
	...
	AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(USkyShooterCombatSet::GetManaAttribute()).AddUObject(this, &ThisClass::HandleManaChanged);
	AbilitySystemComponent->GetGameplayAttributeValueChangeDelegate(USkyShooterCombatSet::GetMaxManaAttribute()).AddUObject(this, &ThisClass::HandleMaxManaChanged);
}
