...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonUIExtensions_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonUIExtensions_GetLocalPlayerFromController, "GetLocalPlayerFromController" }, // 3150962522
		{ &Z_Construct_UFunction_UCommonUIExtensions_GetOwningPlayerInputType, "GetOwningPlayerInputType" }, // 4198244361
		{ &Z_Construct_UFunction_UCommonUIExtensions_IsOwningPlayerUsingGamepad, "IsOwningPlayerUsingGamepad" }, // 1197979043
		{ &Z_Construct_UFunction_UCommonUIExtensions_IsOwningPlayerUsingTouch, "IsOwningPlayerUsingTouch" }, // 928973613
		{ &Z_Construct_UFunction_UCommonUIExtensions_PopContentFromLayer, "PopContentFromLayer" }, // 1597836557
		{ &Z_Construct_UFunction_UCommonUIExtensions_PushContentToLayer_ForPlayer, "PushContentToLayer_ForPlayer" }, // 2910266395
		{ &Z_Construct_UFunction_UCommonUIExtensions_PushStreamedContentToLayer_ForPlayer, "PushStreamedContentToLayer_ForPlayer" }, // 2569143022
		{ &Z_Construct_UFunction_UCommonUIExtensions_ResumeInputForPlayer, "ResumeInputForPlayer" }, // 1170214765
		{ &Z_Construct_UFunction_UCommonUIExtensions_SuspendInputForPlayer, "SuspendInputForPlayer" }, // 1781870988
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonUIExtensions_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonUIExtensions_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonUIExtensions, UCommonUIExtensions::StaticClass, TEXT("UCommonUIExtensions"), &Z_Registration_Info_UClass_UCommonUIExtensions, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonUIExtensions), 557687050U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonUIExtensions_h_593127715(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonUIExtensions_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonUIExtensions_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
