...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged_Statics::NewProp_Privilege = { "Privilege", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(CommonGameInstance_eventHandlePrivilegeChanged_Parms, Privilege), Z_Construct_UEnum_CommonUser_ECommonUserPrivilege, METADATA_PARAMS(nullptr, 0) }; // 3520582230
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UCommonGameInstance_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UCommonGameInstance_HandlePrivilegeChanged, "HandlePrivilegeChanged" }, // 155318199
		{ &Z_Construct_UFunction_UCommonGameInstance_HandleSystemMessage, "HandleSystemMessage" }, // 1937370358
	};
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameInstance, UCommonGameInstance::StaticClass, TEXT("UCommonGameInstance"), &Z_Registration_Info_UClass_UCommonGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameInstance), 4215150911U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonGameInstance_h_369074483(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_CommonGameInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
