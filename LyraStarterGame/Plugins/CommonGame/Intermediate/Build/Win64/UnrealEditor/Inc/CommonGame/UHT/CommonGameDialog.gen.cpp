...
template<> COMMONGAME_API UScriptStruct* StaticStruct<FConfirmationDialogAction>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions = { "ButtonActions", nullptr, (EPropertyFlags)0x0010000000000004, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UCommonGameDialogDescriptor, ButtonActions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UCommonGameDialogDescriptor_Statics::NewProp_ButtonActions_MetaData)) }; // 3954604801
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ScriptStructInfo[] = {
		{ FConfirmationDialogAction::StaticStruct, Z_Construct_UScriptStruct_FConfirmationDialogAction_Statics::NewStructOps, TEXT("ConfirmationDialogAction"), &Z_Registration_Info_UScriptStruct_ConfirmationDialogAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FConfirmationDialogAction), 3954604801U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCommonGameDialogDescriptor, UCommonGameDialogDescriptor::StaticClass, TEXT("UCommonGameDialogDescriptor"), &Z_Registration_Info_UClass_UCommonGameDialogDescriptor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameDialogDescriptor), 2504453187U) },
		{ Z_Construct_UClass_UCommonGameDialog, UCommonGameDialog::StaticClass, TEXT("UCommonGameDialog"), &Z_Registration_Info_UClass_UCommonGameDialog, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCommonGameDialog), 621149719U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_478194003(TEXT("/Script/CommonGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_CommonGame_Source_Public_Messaging_CommonGameDialog_h_Statics::ScriptStructInfo),
		nullptr, 0);
