...
#include "Source/Public/SubtitleDisplaySubsystem.h"
...
class UScriptStruct* FSubtitleFormat::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_SubtitleFormat.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FSubtitleFormat, Z_Construct_UPackage__Script_GameSubtitles(), TEXT("SubtitleFormat"));
	}
...
template<> GAMESUBTITLES_API UScriptStruct* StaticStruct<FSubtitleFormat>()
{
	...
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextSize_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextSize = { "SubtitleTextSize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FSubtitleFormat, SubtitleTextSize), Z_Construct_UEnum_GameSubtitles_ESubtitleDisplayTextSize, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextSize_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextSize_MetaData)) }; // 1384371195
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextColor_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextColor = { "SubtitleTextColor", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FSubtitleFormat, SubtitleTextColor), Z_Construct_UEnum_GameSubtitles_ESubtitleDisplayTextColor, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextColor_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextColor_MetaData)) }; // 915025177
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextBorder = { "SubtitleTextBorder", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FSubtitleFormat, SubtitleTextBorder), Z_Construct_UEnum_GameSubtitles_ESubtitleDisplayTextBorder, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextBorder_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleTextBorder_MetaData)) }; // 262301307
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleBackgroundOpacity = { "SubtitleBackgroundOpacity", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FSubtitleFormat, SubtitleBackgroundOpacity), Z_Construct_UEnum_GameSubtitles_ESubtitleDisplayBackgroundOpacity, METADATA_PARAMS(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleBackgroundOpacity_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewProp_SubtitleBackgroundOpacity_MetaData)) }; // 3617249674
	...
	const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FSubtitleFormat_Statics::ReturnStructParams = {
		...
		METADATA_PARAMS(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::Struct_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FSubtitleFormat_Statics::Struct_MetaDataParams))
	};
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_USubtitleDisplaySubsystem_Statics::NewProp_SubtitleFormat = { "SubtitleFormat", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(USubtitleDisplaySubsystem, SubtitleFormat), Z_Construct_UScriptStruct_FSubtitleFormat, METADATA_PARAMS(Z_Construct_UClass_USubtitleDisplaySubsystem_Statics::NewProp_SubtitleFormat_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_USubtitleDisplaySubsystem_Statics::NewProp_SubtitleFormat_MetaData)) }; // 1453765924
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_USubtitleDisplaySubsystem_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_USubtitleDisplaySubsystem_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_USubtitleDisplaySubsystem_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics::ScriptStructInfo[] = {
		{ FSubtitleFormat::StaticStruct, Z_Construct_UScriptStruct_FSubtitleFormat_Statics::NewStructOps, TEXT("SubtitleFormat"), &Z_Registration_Info_UScriptStruct_SubtitleFormat, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSubtitleFormat), 1453765924U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_USubtitleDisplaySubsystem, USubtitleDisplaySubsystem::StaticClass, TEXT("USubtitleDisplaySubsystem"), &Z_Registration_Info_UClass_USubtitleDisplaySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(USubtitleDisplaySubsystem), 585054366U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_206195050(TEXT("/Script/GameSubtitles"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSubtitles_Source_Public_SubtitleDisplaySubsystem_h_Statics::ScriptStructInfo),
		nullptr, 0);
