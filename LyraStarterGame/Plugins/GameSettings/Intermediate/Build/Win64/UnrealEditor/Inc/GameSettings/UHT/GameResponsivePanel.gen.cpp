...
#include "Source/Private/Widgets/Responsive/GameResponsivePanel.h"
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::NewProp_Content = { "Content", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(GameResponsivePanel_eventAddChildToGameResponsivePanel_Parms, Content), Z_Construct_UClass_UWidget_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::NewProp_Content_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::NewProp_Content_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000080588, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(GameResponsivePanel_eventAddChildToGameResponsivePanel_Parms, ReturnValue), Z_Construct_UClass_UGameResponsivePanelSlot_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::NewProp_ReturnValue_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::NewProp_ReturnValue_MetaData)) };
...
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UGameResponsivePanel, nullptr, "AddChildToGameResponsivePanel", nullptr, nullptr, sizeof(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::GameResponsivePanel_eventAddChildToGameResponsivePanel_Parms), Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel_Statics::Function_MetaDataParams)) };
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UGameResponsivePanel_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UGameResponsivePanel_AddChildToGameResponsivePanel, "AddChildToGameResponsivePanel" }, // 3943607646
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UGameResponsivePanel_Statics::NewProp_bCanStackVertically = { "bCanStackVertically", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(UGameResponsivePanel), &Z_Construct_UClass_UGameResponsivePanel_Statics::NewProp_bCanStackVertically_SetBit, METADATA_PARAMS(Z_Construct_UClass_UGameResponsivePanel_Statics::NewProp_bCanStackVertically_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameResponsivePanel_Statics::NewProp_bCanStackVertically_MetaData)) };
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameResponsivePanel_Statics::ClassParams = {
		...
		0,
		0x00A000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameResponsivePanel_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameResponsivePanel_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Private_Widgets_Responsive_GameResponsivePanel_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Private_Widgets_Responsive_GameResponsivePanel_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameResponsivePanel, UGameResponsivePanel::StaticClass, TEXT("UGameResponsivePanel"), &Z_Registration_Info_UClass_UGameResponsivePanel, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameResponsivePanel), 1511318129U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Private_Widgets_Responsive_GameResponsivePanel_h_2861671808(TEXT("/Script/GameSettings"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Private_Widgets_Responsive_GameResponsivePanel_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Private_Widgets_Responsive_GameResponsivePanel_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
