...
#include "Source/Public/GameSettingValueDiscreteDynamic.h"
...
// End Cross Module References
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Statics::Class_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Bool_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Bool_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Bool_Statics::Class_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Number_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Number_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Number_Statics::Class_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Enum_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Enum_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Enum_Statics::Class_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Color_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Color_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Color_Statics::Class_MetaDataParams))
	};
	...
	const UECodeGen_Private::FClassParams Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Vector2D_Statics::ClassParams = {
		...
		0,
		0x001000A0u,
		METADATA_PARAMS(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Vector2D_Statics::Class_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Vector2D_Statics::Class_MetaDataParams))
	};
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingValueDiscreteDynamic_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingValueDiscreteDynamic_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingValueDiscreteDynamic, UGameSettingValueDiscreteDynamic::StaticClass, TEXT("UGameSettingValueDiscreteDynamic"), &Z_Registration_Info_UClass_UGameSettingValueDiscreteDynamic, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingValueDiscreteDynamic), 3779486999U) },
		{ Z_Construct_UClass_UGameSettingValueDiscreteDynamic_Bool, UGameSettingValueDiscreteDynamic_Bool::StaticClass, TEXT("UGameSettingValueDiscreteDynamic_Bool"), &Z_Registration_Info_UClass_UGameSettingValueDiscreteDynamic_Bool, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingValueDiscreteDynamic_Bool), 1918830204U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingValueDiscreteDynamic_h_4268057170(TEXT("/Script/GameSettings"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingValueDiscreteDynamic_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingValueDiscreteDynamic_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
