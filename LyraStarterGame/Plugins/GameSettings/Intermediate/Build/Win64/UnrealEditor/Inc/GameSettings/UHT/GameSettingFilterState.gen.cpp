...
template<> GAMESETTINGS_API UScriptStruct* StaticStruct<FGameSettingFilterState>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_new_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingFilterState_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_new_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingFilterState_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_new_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingFilterState_h_3230789770(TEXT("/Script/GameSettings"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_new_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingFilterState_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_new_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingFilterState_h_Statics::ScriptStructInfo),
		nullptr, 0);
