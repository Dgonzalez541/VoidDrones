...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameSettingRegistry_Statics::NewProp_TopLevelSettings = { "TopLevelSettings", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UGameSettingRegistry, TopLevelSettings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGameSettingRegistry_Statics::NewProp_TopLevelSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingRegistry_Statics::NewProp_TopLevelSettings_MetaData)) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UGameSettingRegistry_Statics::NewProp_RegisteredSettings = { "RegisteredSettings", nullptr, (EPropertyFlags)0x0024080000002000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UGameSettingRegistry, RegisteredSettings), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_UGameSettingRegistry_Statics::NewProp_RegisteredSettings_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UGameSettingRegistry_Statics::NewProp_RegisteredSettings_MetaData)) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingRegistry_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingRegistry_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameSettingRegistry, UGameSettingRegistry::StaticClass, TEXT("UGameSettingRegistry"), &Z_Registration_Info_UClass_UGameSettingRegistry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameSettingRegistry), 3637520569U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingRegistry_h_4077295847(TEXT("/Script/GameSettings"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingRegistry_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SKyShooterOld_SkyShooter_LyraStarterGame_Plugins_GameSettings_Source_Public_GameSettingRegistry_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
