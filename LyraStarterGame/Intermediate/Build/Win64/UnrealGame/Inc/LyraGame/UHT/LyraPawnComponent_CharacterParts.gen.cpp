...
class UScriptStruct* FLyraAppliedCharacterPartEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAppliedCharacterPartEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAppliedCharacterPartEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAppliedCharacterPartEntry"));
	}
...
class UScriptStruct* FLyraCharacterPartList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraCharacterPartList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraCharacterPartList, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraCharacterPartList"));
	}
...
UE_NET_IMPLEMENT_FASTARRAY(FLyraCharacterPartList);
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_2168415766(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraPawnComponent_CharacterParts_h_Statics::ScriptStructInfo),
		nullptr, 0);
