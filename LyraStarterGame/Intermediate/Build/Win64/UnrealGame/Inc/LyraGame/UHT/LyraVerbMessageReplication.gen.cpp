...
class UScriptStruct* FLyraVerbMessageReplicationEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraVerbMessageReplicationEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraVerbMessageReplicationEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraVerbMessageReplicationEntry"));
	}
...
class UScriptStruct* FLyraVerbMessageReplication::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraVerbMessageReplication.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraVerbMessageReplication, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraVerbMessageReplication"));
	}
...
UE_NET_IMPLEMENT_FASTARRAY(FLyraVerbMessageReplication);
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraVerbMessageReplication_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraVerbMessageReplication_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraVerbMessageReplication_h_3994060102(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraVerbMessageReplication_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraVerbMessageReplication_h_Statics::ScriptStructInfo),
		nullptr, 0);
