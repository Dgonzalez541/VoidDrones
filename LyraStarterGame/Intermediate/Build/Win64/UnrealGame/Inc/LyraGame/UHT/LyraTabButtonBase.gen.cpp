...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraTabButtonBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraTabButtonBase_SetTabLabelInfo_Implementation, "SetTabLabelInfo_Implementation" }, // 969716783
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULyraTabButtonBase_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ULyraTabButtonBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULyraTabButtonInterface_NoRegister, (int32)VTABLE_OFFSET(ULyraTabButtonBase, ILyraTabButtonInterface), false },  // 3349066895
		};
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Common_LyraTabButtonBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Common_LyraTabButtonBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraTabButtonBase, ULyraTabButtonBase::StaticClass, TEXT("ULyraTabButtonBase"), &Z_Registration_Info_UClass_ULyraTabButtonBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraTabButtonBase), 2382096413U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Common_LyraTabButtonBase_h_3385691519(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Common_LyraTabButtonBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Common_LyraTabButtonBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
