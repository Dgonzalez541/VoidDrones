...
// End Cross Module References
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraPlayerController, ALyraPlayerController::StaticClass, TEXT("ALyraPlayerController"), &Z_Registration_Info_UClass_ALyraPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraPlayerController), 2609101488U) },
		{ Z_Construct_UClass_ALyraReplayPlayerController, ALyraReplayPlayerController::StaticClass, TEXT("ALyraReplayPlayerController"), &Z_Registration_Info_UClass_ALyraReplayPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraReplayPlayerController), 3154681058U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerController_h_3558861117(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
