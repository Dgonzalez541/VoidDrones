...
class UScriptStruct* FLyraInventoryChangeMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInventoryChangeMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInventoryChangeMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraInventoryChangeMessage"));
	}
...
class UScriptStruct* FLyraInventoryEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInventoryEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInventoryEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraInventoryEntry"));
	}
...
class UScriptStruct* FLyraInventoryList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInventoryList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInventoryList, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraInventoryList"));
	}
...
UE_NET_IMPLEMENT_FASTARRAY(FLyraInventoryList);
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_1690209970(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_LyraInventoryManagerComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
