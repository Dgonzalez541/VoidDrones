...
class UScriptStruct* FLyraAbilityGrant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilityGrant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilityGrant, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilityGrant"));
	}
...
class UScriptStruct* FLyraAttributeSetGrant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAttributeSetGrant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAttributeSetGrant, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAttributeSetGrant"));
	}
...
class UScriptStruct* FGameFeatureAbilitiesEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameFeatureAbilitiesEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameFeatureAbilitiesEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("GameFeatureAbilitiesEntry"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FGameFeatureAbilitiesEntry>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_3124205854(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ScriptStructInfo),
		nullptr, 0);
