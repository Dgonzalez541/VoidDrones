...
class UScriptStruct* FLyraScalabilitySnapshot::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraScalabilitySnapshot.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraScalabilitySnapshot, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraScalabilitySnapshot"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraScalabilitySnapshot>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraSettingsLocal, ULyraSettingsLocal::StaticClass, TEXT("ULyraSettingsLocal"), &Z_Registration_Info_UClass_ULyraSettingsLocal, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraSettingsLocal), 515506679U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_1052814280(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Settings_LyraSettingsLocal_h_Statics::ScriptStructInfo),
		nullptr, 0);
