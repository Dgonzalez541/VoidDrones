...
// End Cross Module References
	...
	static UEnum* ELyraStatDisplayMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraStatDisplayMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraStatDisplayMode, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraStatDisplayMode"));
		}
	...
	static UEnum* ELyraDisplayablePerformanceStat_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraDisplayablePerformanceStat, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraDisplayablePerformanceStat"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceStatTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceStatTypes_h_Statics::EnumInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceStatTypes_h_207523151(TEXT("/Script/LyraGame"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceStatTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceStatTypes_h_Statics::EnumInfo));
