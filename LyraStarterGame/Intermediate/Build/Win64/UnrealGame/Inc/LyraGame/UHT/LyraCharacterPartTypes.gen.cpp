...
// End Cross Module References
	...
	static UEnum* ECharacterCustomizationCollisionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECharacterCustomizationCollisionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ECharacterCustomizationCollisionMode, Z_Construct_UPackage__Script_LyraGame(), TEXT("ECharacterCustomizationCollisionMode"));
		}
...
class UScriptStruct* FLyraCharacterPartHandle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraCharacterPartHandle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraCharacterPartHandle, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraCharacterPartHandle"));
	}
...
class UScriptStruct* FLyraCharacterPart::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraCharacterPart.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraCharacterPart, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraCharacterPart"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraCharacterPart>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_598015191(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCharacterPartTypes_h_Statics::EnumInfo));
