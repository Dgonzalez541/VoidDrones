...
class UScriptStruct* FLyraEquipmentActorToSpawn::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraEquipmentActorToSpawn.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraEquipmentActorToSpawn, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraEquipmentActorToSpawn"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraEquipmentActorToSpawn>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_2290971037(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentDefinition_h_Statics::ScriptStructInfo),
		nullptr, 0);
