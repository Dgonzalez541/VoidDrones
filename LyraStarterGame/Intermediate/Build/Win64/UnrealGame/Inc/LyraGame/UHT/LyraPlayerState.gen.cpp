...
// End Cross Module References
	...
	static UEnum* ELyraPlayerConnectionType_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraPlayerConnectionType.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraPlayerConnectionType, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraPlayerConnectionType"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraPlayerState, ALyraPlayerState::StaticClass, TEXT("ALyraPlayerState"), &Z_Registration_Info_UClass_ALyraPlayerState, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraPlayerState), 1678081139U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_308690215(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Player_LyraPlayerState_h_Statics::EnumInfo));
