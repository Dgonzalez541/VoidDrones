...
class UScriptStruct* FLyraAbilityTagRelationship::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilityTagRelationship.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilityTagRelationship, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilityTagRelationship"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraAbilityTagRelationship>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_318212845(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ScriptStructInfo),
		nullptr, 0);
