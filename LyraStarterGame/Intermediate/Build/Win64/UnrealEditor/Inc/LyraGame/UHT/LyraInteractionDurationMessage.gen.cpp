...
class UScriptStruct* FLyraInteractionDurationMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInteractionDurationMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInteractionDurationMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraInteractionDurationMessage"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraInteractionDurationMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_LyraInteractionDurationMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_LyraInteractionDurationMessage_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_LyraInteractionDurationMessage_h_1762666621(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_LyraInteractionDurationMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_LyraInteractionDurationMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
