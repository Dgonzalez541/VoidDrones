...
class UScriptStruct* FLyraQualityDeviceProfileVariant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraQualityDeviceProfileVariant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraQualityDeviceProfileVariant, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraQualityDeviceProfileVariant"));
	}
...
class UScriptStruct* FLyraPerformanceStatGroup::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraPerformanceStatGroup.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraPerformanceStatGroup, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraPerformanceStatGroup"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraPerformanceStatGroup>()
{
	...
	static UEnum* ELyraFramePacingMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraFramePacingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraFramePacingMode, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraFramePacingMode"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_3162455242(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Performance_LyraPerformanceSettings_h_Statics::EnumInfo));
