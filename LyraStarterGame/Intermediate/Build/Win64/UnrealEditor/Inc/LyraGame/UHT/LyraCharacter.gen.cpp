...
class UScriptStruct* FLyraReplicatedAcceleration::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraReplicatedAcceleration.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraReplicatedAcceleration, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraReplicatedAcceleration"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraReplicatedAcceleration>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraCharacter, ALyraCharacter::StaticClass, TEXT("ALyraCharacter"), &Z_Registration_Info_UClass_ALyraCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraCharacter), 947979878U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_2925713591(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Character_LyraCharacter_h_Statics::ScriptStructInfo),
		nullptr, 0);
