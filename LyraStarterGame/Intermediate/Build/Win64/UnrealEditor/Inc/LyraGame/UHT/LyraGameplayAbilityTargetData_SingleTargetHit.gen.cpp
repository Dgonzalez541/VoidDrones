...
class UScriptStruct* FLyraGameplayAbilityTargetData_SingleTargetHit::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraGameplayAbilityTargetData_SingleTargetHit.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraGameplayAbilityTargetData_SingleTargetHit, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraGameplayAbilityTargetData_SingleTargetHit"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraGameplayAbilityTargetData_SingleTargetHit>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_2141339466(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics::ScriptStructInfo),
		nullptr, 0);
