...
class UScriptStruct* FInteractionOption::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InteractionOption.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInteractionOption, Z_Construct_UPackage__Script_LyraGame(), TEXT("InteractionOption"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FInteractionOption>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionOption_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionOption_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionOption_h_3210385694(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionOption_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionOption_h_Statics::ScriptStructInfo),
		nullptr, 0);
