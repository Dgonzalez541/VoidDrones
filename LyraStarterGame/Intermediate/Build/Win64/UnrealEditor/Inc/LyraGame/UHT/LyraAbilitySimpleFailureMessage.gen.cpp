...
class UScriptStruct* FLyraAbilitySimpleFailureMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilitySimpleFailureMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilitySimpleFailureMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilitySimpleFailureMessage"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraAbilitySimpleFailureMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_2031239076(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
