...
class UScriptStruct* FLyraAnimLayerSelectionEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAnimLayerSelectionEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAnimLayerSelectionEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAnimLayerSelectionEntry"));
	}
...
class UScriptStruct* FLyraAnimLayerSelectionSet::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAnimLayerSelectionSet.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAnimLayerSelectionSet, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAnimLayerSelectionSet"));
	}
...
class UScriptStruct* FLyraAnimBodyStyleSelectionEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAnimBodyStyleSelectionEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAnimBodyStyleSelectionEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAnimBodyStyleSelectionEntry"));
	}
...
class UScriptStruct* FLyraAnimBodyStyleSelectionSet::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAnimBodyStyleSelectionSet.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAnimBodyStyleSelectionSet, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAnimBodyStyleSelectionSet"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraAnimBodyStyleSelectionSet>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCosmeticAnimationTypes_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCosmeticAnimationTypes_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCosmeticAnimationTypes_h_47291507(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCosmeticAnimationTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Cosmetics_LyraCosmeticAnimationTypes_h_Statics::ScriptStructInfo),
		nullptr, 0);
