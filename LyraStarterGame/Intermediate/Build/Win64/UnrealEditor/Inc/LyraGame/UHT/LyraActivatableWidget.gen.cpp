...
// End Cross Module References
	...
	static UEnum* ELyraWidgetInputMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraWidgetInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraWidgetInputMode, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraWidgetInputMode"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics::EnumInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraActivatableWidget, ULyraActivatableWidget::StaticClass, TEXT("ULyraActivatableWidget"), &Z_Registration_Info_UClass_ULyraActivatableWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraActivatableWidget), 1946217056U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_2551838683(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_LyraActivatableWidget_h_Statics::EnumInfo));
