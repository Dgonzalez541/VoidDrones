...
// End Cross Module References
	...
	static UEnum* ELyraAbilityActivationPolicy_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraAbilityActivationPolicy.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraAbilityActivationPolicy, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraAbilityActivationPolicy"));
		}
	...
	static UEnum* ELyraAbilityActivationGroup_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraAbilityActivationGroup.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraAbilityActivationGroup, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraAbilityActivationGroup"));
		}
...
class UScriptStruct* FLyraAbilityMontageFailureMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilityMontageFailureMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilityMontageFailureMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilityMontageFailureMessage"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraAbilityMontageFailureMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_146156632(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_h_Statics::EnumInfo));
