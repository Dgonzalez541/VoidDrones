...
class UScriptStruct* FLyraAudioSubmixEffectsChain::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAudioSubmixEffectsChain.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAudioSubmixEffectsChain, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAudioSubmixEffectsChain"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraAudioSubmixEffectsChain>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_2043391602(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Audio_LyraAudioMixEffectsSubsystem_h_Statics::ScriptStructInfo),
		nullptr, 0);
