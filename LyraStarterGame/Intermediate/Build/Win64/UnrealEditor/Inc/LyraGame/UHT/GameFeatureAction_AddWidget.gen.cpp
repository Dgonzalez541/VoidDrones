...
class UScriptStruct* FLyraHUDLayoutRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraHUDLayoutRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraHUDLayoutRequest, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraHUDLayoutRequest"));
	}
...
class UScriptStruct* FLyraHUDElementEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraHUDElementEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraHUDElementEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraHUDElementEntry"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraHUDElementEntry>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_3577198819(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ScriptStructInfo),
		nullptr, 0);
