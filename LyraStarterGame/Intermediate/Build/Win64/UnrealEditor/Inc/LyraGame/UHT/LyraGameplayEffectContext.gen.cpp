...
class UScriptStruct* FLyraGameplayEffectContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraGameplayEffectContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraGameplayEffectContext, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraGameplayEffectContext"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraGameplayEffectContext>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayEffectContext_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayEffectContext_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayEffectContext_h_892048984(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayEffectContext_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGameplayEffectContext_h_Statics::ScriptStructInfo),
		nullptr, 0);
