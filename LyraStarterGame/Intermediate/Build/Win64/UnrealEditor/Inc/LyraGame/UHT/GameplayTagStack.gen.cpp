...
class UScriptStruct* FGameplayTagStack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayTagStack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagStack, Z_Construct_UPackage__Script_LyraGame(), TEXT("GameplayTagStack"));
	}
...
class UScriptStruct* FGameplayTagStackContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayTagStackContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagStackContainer, Z_Construct_UPackage__Script_LyraGame(), TEXT("GameplayTagStackContainer"));
	}
...
UE_NET_IMPLEMENT_FASTARRAY(FGameplayTagStackContainer);
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks = { "Stacks", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FGameplayTagStackContainer, Stacks), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks_MetaData)) }; // 3339208656
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_System_GameplayTagStack_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_System_GameplayTagStack_h_Statics::ScriptStructInfo[] = {
		{ FGameplayTagStack::StaticStruct, Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewStructOps, TEXT("GameplayTagStack"), &Z_Registration_Info_UScriptStruct_GameplayTagStack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayTagStack), 3339208656U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_System_GameplayTagStack_h_755886829(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_System_GameplayTagStack_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_System_GameplayTagStack_h_Statics::ScriptStructInfo),
		nullptr, 0);
