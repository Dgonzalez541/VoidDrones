...
class UScriptStruct* FLyraTeamTrackingInfo::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraTeamTrackingInfo.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraTeamTrackingInfo, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraTeamTrackingInfo"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraTeamTrackingInfo>()
{
	...
	static UEnum* ELyraTeamComparison_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraTeamComparison.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_LyraGame_ELyraTeamComparison, Z_Construct_UPackage__Script_LyraGame(), TEXT("ELyraTeamComparison"));
		}
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::EnumInfo[] = {
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_2722211564(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Teams_LyraTeamSubsystem_h_Statics::EnumInfo));
