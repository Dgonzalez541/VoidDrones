...
class UScriptStruct* FLyraAppliedEquipmentEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAppliedEquipmentEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAppliedEquipmentEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAppliedEquipmentEntry"));
	}
...
class UScriptStruct* FLyraEquipmentList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraEquipmentList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraEquipmentList, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraEquipmentList"));
	}
...
UE_NET_IMPLEMENT_FASTARRAY(FLyraEquipmentList);
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_91724909(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraEquipmentManagerComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
