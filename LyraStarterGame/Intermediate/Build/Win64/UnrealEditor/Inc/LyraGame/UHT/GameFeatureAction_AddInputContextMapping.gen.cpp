...
class UScriptStruct* FInputMappingContextAndPriority::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputMappingContextAndPriority.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputMappingContextAndPriority, Z_Construct_UPackage__Script_LyraGame(), TEXT("InputMappingContextAndPriority"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FInputMappingContextAndPriority>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping, UGameFeatureAction_AddInputContextMapping::StaticClass, TEXT("UGameFeatureAction_AddInputContextMapping"), &Z_Registration_Info_UClass_UGameFeatureAction_AddInputContextMapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_AddInputContextMapping), 3580859638U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_2662568767(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo),
		nullptr, 0);
