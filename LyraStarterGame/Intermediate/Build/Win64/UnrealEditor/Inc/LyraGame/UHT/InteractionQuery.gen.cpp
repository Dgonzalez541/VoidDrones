...
class UScriptStruct* FInteractionQuery::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InteractionQuery.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInteractionQuery, Z_Construct_UPackage__Script_LyraGame(), TEXT("InteractionQuery"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FInteractionQuery>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionQuery_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionQuery_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionQuery_h_1239866707(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionQuery_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Interaction_InteractionQuery_h_Statics::ScriptStructInfo),
		nullptr, 0);
