...
class UScriptStruct* FLyraAbilitySet_GameplayAbility::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilitySet_GameplayAbility.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilitySet_GameplayAbility, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilitySet_GameplayAbility"));
	}
...
class UScriptStruct* FLyraAbilitySet_GameplayEffect::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilitySet_GameplayEffect.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilitySet_GameplayEffect, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilitySet_GameplayEffect"));
	}
...
class UScriptStruct* FLyraAbilitySet_AttributeSet::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilitySet_AttributeSet.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilitySet_AttributeSet, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilitySet_AttributeSet"));
	}
...
class UScriptStruct* FLyraAbilitySet_GrantedHandles::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilitySet_GrantedHandles.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilitySet_GrantedHandles, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraAbilitySet_GrantedHandles"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraAbilitySet_GrantedHandles>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_2200437373(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraAbilitySet_h_Statics::ScriptStructInfo),
		nullptr, 0);
