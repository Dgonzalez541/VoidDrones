...
class UScriptStruct* FLyraPlayerResetMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraPlayerResetMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraPlayerResetMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraPlayerResetMessage"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraPlayerResetMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_1494006260(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ScriptStructInfo),
		nullptr, 0);
