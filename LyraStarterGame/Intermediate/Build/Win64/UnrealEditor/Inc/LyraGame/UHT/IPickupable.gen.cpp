...
class UScriptStruct* FPickupTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PickupTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPickupTemplate, Z_Construct_UPackage__Script_LyraGame(), TEXT("PickupTemplate"));
	}
...
class UScriptStruct* FPickupInstance::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PickupInstance.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPickupInstance, Z_Construct_UPackage__Script_LyraGame(), TEXT("PickupInstance"));
	}
...
class UScriptStruct* FInventoryPickup::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InventoryPickup.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInventoryPickup, Z_Construct_UPackage__Script_LyraGame(), TEXT("InventoryPickup"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FInventoryPickup>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_3278010450(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Inventory_IPickupable_h_Statics::ScriptStructInfo),
		nullptr, 0);
