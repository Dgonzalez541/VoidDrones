...
class UScriptStruct* FLyraQuickBarSlotsChangedMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraQuickBarSlotsChangedMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraQuickBarSlotsChangedMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraQuickBarSlotsChangedMessage"));
	}
...
class UScriptStruct* FLyraQuickBarActiveIndexChangedMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraQuickBarActiveIndexChangedMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraQuickBarActiveIndexChangedMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraQuickBarActiveIndexChangedMessage"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraQuickBarActiveIndexChangedMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_1875293403(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Equipment_LyraQuickBarComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
