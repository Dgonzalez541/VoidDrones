...
class UScriptStruct* FPooledNumberPopComponentList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PooledNumberPopComponentList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPooledNumberPopComponentList, Z_Construct_UPackage__Script_LyraGame(), TEXT("PooledNumberPopComponentList"));
	}
...
class UScriptStruct* FLiveNumberPopEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LiveNumberPopEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLiveNumberPopEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("LiveNumberPopEntry"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLiveNumberPopEntry>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_3402172111(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ScriptStructInfo),
		nullptr, 0);
