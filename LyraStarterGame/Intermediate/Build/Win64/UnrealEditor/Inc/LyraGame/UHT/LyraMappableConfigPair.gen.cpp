...
class UScriptStruct* FLoadedMappableConfigPair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LoadedMappableConfigPair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLoadedMappableConfigPair, Z_Construct_UPackage__Script_LyraGame(), TEXT("LoadedMappableConfigPair"));
	}
...
class UScriptStruct* FMappableConfigPair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MappableConfigPair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMappableConfigPair, Z_Construct_UPackage__Script_LyraGame(), TEXT("MappableConfigPair"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FMappableConfigPair>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Input_LyraMappableConfigPair_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Input_LyraMappableConfigPair_h_Statics::ScriptStructInfo[] = {
		{ FLoadedMappableConfigPair::StaticStruct, Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewStructOps, TEXT("LoadedMappableConfigPair"), &Z_Registration_Info_UScriptStruct_LoadedMappableConfigPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLoadedMappableConfigPair), 3842060373U) },
		{ FMappableConfigPair::StaticStruct, Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewStructOps, TEXT("MappableConfigPair"), &Z_Registration_Info_UScriptStruct_MappableConfigPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMappableConfigPair), 2889537211U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Input_LyraMappableConfigPair_h_2014971703(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Input_LyraMappableConfigPair_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Input_LyraMappableConfigPair_h_Statics::ScriptStructInfo),
		nullptr, 0);
