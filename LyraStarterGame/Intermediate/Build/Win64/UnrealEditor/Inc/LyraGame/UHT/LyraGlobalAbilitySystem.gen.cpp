...
class UScriptStruct* FGlobalAppliedAbilityList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GlobalAppliedAbilityList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGlobalAppliedAbilityList, Z_Construct_UPackage__Script_LyraGame(), TEXT("GlobalAppliedAbilityList"));
	}
...
class UScriptStruct* FGlobalAppliedEffectList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GlobalAppliedEffectList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGlobalAppliedEffectList, Z_Construct_UPackage__Script_LyraGame(), TEXT("GlobalAppliedEffectList"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FGlobalAppliedEffectList>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_3651947320(TEXT("/Script/LyraGame"),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_AbilitySystem_LyraGlobalAbilitySystem_h_Statics::ScriptStructInfo),
		nullptr, 0);
