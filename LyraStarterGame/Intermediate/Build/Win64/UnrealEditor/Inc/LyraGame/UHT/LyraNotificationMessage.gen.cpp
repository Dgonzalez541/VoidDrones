...
class UScriptStruct* FLyraNotificationMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraNotificationMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraNotificationMessage, Z_Construct_UPackage__Script_LyraGame(), TEXT("LyraNotificationMessage"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FLyraNotificationMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraNotificationMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraNotificationMessage_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraNotificationMessage_h_884293303(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraNotificationMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_Messages_LyraNotificationMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
