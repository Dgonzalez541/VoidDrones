...
class UScriptStruct* FCircumferenceMarkerEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CircumferenceMarkerEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCircumferenceMarkerEntry, Z_Construct_UPackage__Script_LyraGame(), TEXT("CircumferenceMarkerEntry"));
	}
...
template<> LYRAGAME_API UScriptStruct* StaticStruct<FCircumferenceMarkerEntry>()
{
	...
	struct Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Weapons_SCircumferenceMarkerWidget_h_3595713433(TEXT("/Script/LyraGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_SkyShooter_SkyShooter_LyraStarterGame_Source_LyraGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics::ScriptStructInfo),
		nullptr, 0);
