...
struct SKYSHOOTERGAME_API FLyraContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SKYSHOOTERGAME_API FLyraContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SKYSHOOTERGAME_API FLyraContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct SKYSHOOTERGAME_API FLyraContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
...
class SKYSHOOTERGAME_API UAnimNotify_LyraContextEffects : public UAnimNotify
{
	GENERATED_BODY()
