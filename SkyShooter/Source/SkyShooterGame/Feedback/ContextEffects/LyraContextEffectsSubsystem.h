...
class SKYSHOOTERGAME_API ULyraContextEffectsSettings : public UDeveloperSettings
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SKYSHOOTERGAME_API ULyraContextEffectsSet : public UObject
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SKYSHOOTERGAME_API ULyraContextEffectsSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
