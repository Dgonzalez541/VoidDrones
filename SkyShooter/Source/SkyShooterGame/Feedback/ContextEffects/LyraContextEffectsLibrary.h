...
struct SKYSHOOTERGAME_API FLyraContextEffects
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class SKYSHOOTERGAME_API ULyraActiveContextEffects : public UObject
{
	GENERATED_BODY()
...
class SKYSHOOTERGAME_API ULyraContextEffectsLibrary : public UObject
{
	GENERATED_BODY()
