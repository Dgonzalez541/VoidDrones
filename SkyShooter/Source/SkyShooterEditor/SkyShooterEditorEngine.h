...
#include "SkyShooterEditorEngine.generated.h"
...
UCLASS()
class USkyShooterEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	USkyShooterEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
