...
#include "SkyShooterGame/AbilitySystem/Abilities/LyraAbilityCost.h"
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraAbilityCost>()
	{
		return ULyraAbilityCost::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraAbilityCost);
	ULyraAbilityCost::~ULyraAbilityCost() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilityCost_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilityCost_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraAbilityCost, ULyraAbilityCost::StaticClass, TEXT("ULyraAbilityCost"), &Z_Registration_Info_UClass_ULyraAbilityCost, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraAbilityCost), 1927000753U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilityCost_h_3576970545(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilityCost_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilityCost_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
