...
#include "SkyShooterGame/Player/LyraPlayerController.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraHUD_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraPlayerController();
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraReplayPlayerController();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraReplayPlayerController_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAbilitySystemComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraAssistInterface_NoRegister();
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ALyraPlayerController_Statics::NewProp_OnTeamChangedDelegate = { "OnTeamChangedDelegate", nullptr, (EPropertyFlags)0x0040000000080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ALyraPlayerController, OnTeamChangedDelegate), Z_Construct_UDelegateFunction_SkyShooterGame_OnLyraTeamIndexChangedDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ALyraPlayerController_Statics::NewProp_OnTeamChangedDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALyraPlayerController_Statics::NewProp_OnTeamChangedDelegate_MetaData)) }; // 148292558
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALyraPlayerController_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ALyraPlayerController_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULyraCameraAssistInterface_NoRegister, (int32)VTABLE_OFFSET(ALyraPlayerController, ILyraCameraAssistInterface), false },  // 3737729287
			{ Z_Construct_UClass_ULyraTeamAgentInterface_NoRegister, (int32)VTABLE_OFFSET(ALyraPlayerController, ILyraTeamAgentInterface), false },  // 3557573541
		};
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraPlayerController>()
	{
		return ALyraPlayerController::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraReplayPlayerController>()
	{
		return ALyraReplayPlayerController::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALyraReplayPlayerController);
	ALyraReplayPlayerController::~ALyraReplayPlayerController() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraPlayerController, ALyraPlayerController::StaticClass, TEXT("ALyraPlayerController"), &Z_Registration_Info_UClass_ALyraPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraPlayerController), 4144908214U) },
		{ Z_Construct_UClass_ALyraReplayPlayerController, ALyraReplayPlayerController::StaticClass, TEXT("ALyraReplayPlayerController"), &Z_Registration_Info_UClass_ALyraReplayPlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraReplayPlayerController), 3645358372U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerController_h_2224428424(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
