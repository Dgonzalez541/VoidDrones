...
class UScriptStruct* FLyraPenetrationAvoidanceFeeler::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraPenetrationAvoidanceFeeler.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraPenetrationAvoidanceFeeler, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraPenetrationAvoidanceFeeler"));
	}
	return Z_Registration_Info_UScriptStruct_LyraPenetrationAvoidanceFeeler.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraPenetrationAvoidanceFeeler>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPenetrationAvoidanceFeeler_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPenetrationAvoidanceFeeler_h_Statics::ScriptStructInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPenetrationAvoidanceFeeler_h_2392654024(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPenetrationAvoidanceFeeler_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPenetrationAvoidanceFeeler_h_Statics::ScriptStructInfo),
		nullptr, 0);
