...
class UScriptStruct* FInteractionQuery::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InteractionQuery.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInteractionQuery, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("InteractionQuery"));
	}
	return Z_Registration_Info_UScriptStruct_InteractionQuery.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FInteractionQuery>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionQuery_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionQuery_h_Statics::ScriptStructInfo[] = {
		{ FInteractionQuery::StaticStruct, Z_Construct_UScriptStruct_FInteractionQuery_Statics::NewStructOps, TEXT("InteractionQuery"), &Z_Registration_Info_UScriptStruct_InteractionQuery, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInteractionQuery), 1169031921U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionQuery_h_3477314595(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionQuery_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionQuery_h_Statics::ScriptStructInfo),
		nullptr, 0);
