...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraPlayerCameraManager();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraPlayerCameraManager_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraPlayerCameraManager>()
	{
		return ALyraPlayerCameraManager::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALyraPlayerCameraManager);
	ALyraPlayerCameraManager::~ALyraPlayerCameraManager() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPlayerCameraManager_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPlayerCameraManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraPlayerCameraManager, ALyraPlayerCameraManager::StaticClass, TEXT("ALyraPlayerCameraManager"), &Z_Registration_Info_UClass_ALyraPlayerCameraManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraPlayerCameraManager), 1995264940U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPlayerCameraManager_h_264665580(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPlayerCameraManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraPlayerCameraManager_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
