...
#include "SkyShooterGame/UI/IndicatorSystem/IndicatorLibrary.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIndicatorLibrary() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AController_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_UBlueprintFunctionLibrary();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UIndicatorLibrary();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UIndicatorLibrary_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UIndicatorLibrary>()
	{
		return UIndicatorLibrary::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UIndicatorLibrary);
	UIndicatorLibrary::~UIndicatorLibrary() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLibrary_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIndicatorLibrary, UIndicatorLibrary::StaticClass, TEXT("UIndicatorLibrary"), &Z_Registration_Info_UClass_UIndicatorLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIndicatorLibrary), 815898113U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLibrary_h_2492741381(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLibrary_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLibrary_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
