...
#include "SkyShooterGame/Input/LyraInputConfig.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInputConfig();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInputConfig_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraInputAction();
...
class UScriptStruct* FLyraInputAction::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInputAction.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInputAction, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraInputAction"));
	}
	return Z_Registration_Info_UScriptStruct_LyraInputAction.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraInputAction>()
{
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULyraInputConfig_Statics::NewProp_NativeInputActions = { "NativeInputActions", nullptr, (EPropertyFlags)0x0010000000010015, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraInputConfig, NativeInputActions), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULyraInputConfig_Statics::NewProp_NativeInputActions_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraInputConfig_Statics::NewProp_NativeInputActions_MetaData)) }; // 3379895942
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraInputConfig>()
	{
		return ULyraInputConfig::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraInputConfig);
	ULyraInputConfig::~ULyraInputConfig() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics::ScriptStructInfo[] = {
		{ FLyraInputAction::StaticStruct, Z_Construct_UScriptStruct_FLyraInputAction_Statics::NewStructOps, TEXT("LyraInputAction"), &Z_Registration_Info_UScriptStruct_LyraInputAction, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraInputAction), 3379895942U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraInputConfig, ULyraInputConfig::StaticClass, TEXT("ULyraInputConfig"), &Z_Registration_Info_UClass_ULyraInputConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraInputConfig), 3402921064U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_1331976028(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraInputConfig_h_Statics::ScriptStructInfo),
		nullptr, 0);
