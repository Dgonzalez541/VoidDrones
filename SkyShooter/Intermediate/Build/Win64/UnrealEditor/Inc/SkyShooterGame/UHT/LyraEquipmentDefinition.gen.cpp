...
#include "SkyShooterGame/Equipment/LyraEquipmentDefinition.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraEquipmentDefinition();
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraEquipmentActorToSpawn();
...
class UScriptStruct* FLyraEquipmentActorToSpawn::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraEquipmentActorToSpawn.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraEquipmentActorToSpawn, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraEquipmentActorToSpawn"));
	}
	return Z_Registration_Info_UScriptStruct_LyraEquipmentActorToSpawn.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraEquipmentActorToSpawn>()
{
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraEquipmentDefinition>()
	{
		return ULyraEquipmentDefinition::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraEquipmentDefinition);
	ULyraEquipmentDefinition::~ULyraEquipmentDefinition() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics::ScriptStructInfo[] = {
		{ FLyraEquipmentActorToSpawn::StaticStruct, Z_Construct_UScriptStruct_FLyraEquipmentActorToSpawn_Statics::NewStructOps, TEXT("LyraEquipmentActorToSpawn"), &Z_Registration_Info_UScriptStruct_LyraEquipmentActorToSpawn, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraEquipmentActorToSpawn), 23374145U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraEquipmentDefinition, ULyraEquipmentDefinition::StaticClass, TEXT("ULyraEquipmentDefinition"), &Z_Registration_Info_UClass_ULyraEquipmentDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraEquipmentDefinition), 1394033665U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_4002243913(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraEquipmentDefinition_h_Statics::ScriptStructInfo),
		nullptr, 0);
