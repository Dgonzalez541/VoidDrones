...
#include "SkyShooterGame/Settings/LyraSettingsShared.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraLocalPlayer_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraSettingsShared();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraSettingsShared_NoRegister();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_EColorBlindMode();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity();
...
// End Cross Module References
	...
	static UEnum* EColorBlindMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EColorBlindMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_EColorBlindMode, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("EColorBlindMode"));
		}
		return Z_Registration_Info_UEnum_EColorBlindMode.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<EColorBlindMode>()
	{
		return EColorBlindMode_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"EColorBlindMode",
		"EColorBlindMode",
		Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_EColorBlindMode()
	{
		if (!Z_Registration_Info_UEnum_EColorBlindMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EColorBlindMode.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_EColorBlindMode_Statics::EnumParams);
		}
	...
	static UEnum* ELyraAllowBackgroundAudioSetting_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraAllowBackgroundAudioSetting.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraAllowBackgroundAudioSetting"));
		}
		return Z_Registration_Info_UEnum_ELyraAllowBackgroundAudioSetting.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<ELyraAllowBackgroundAudioSetting>()
	{
		return ELyraAllowBackgroundAudioSetting_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::Enum_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraAllowBackgroundAudioSetting",
		"ELyraAllowBackgroundAudioSetting",
		Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting()
	{
		if (!Z_Registration_Info_UEnum_ELyraAllowBackgroundAudioSetting.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraAllowBackgroundAudioSetting.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting_Statics::EnumParams);
		}
	...
	static UEnum* ELyraGamepadSensitivity_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraGamepadSensitivity.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraGamepadSensitivity"));
		}
		return Z_Registration_Info_UEnum_ELyraGamepadSensitivity.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<ELyraGamepadSensitivity>()
	{
		return ELyraGamepadSensitivity_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraGamepadSensitivity",
		"ELyraGamepadSensitivity",
		Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity()
	{
		if (!Z_Registration_Info_UEnum_ELyraGamepadSensitivity.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraGamepadSensitivity.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity_Statics::EnumParams);
		}
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULyraSettingsShared_GetAllowAudioInBackgroundSetting_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(LyraSettingsShared_eventGetAllowAudioInBackgroundSetting_Parms, ReturnValue), Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting, METADATA_PARAMS(nullptr, 0) }; // 1224005849
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULyraSettingsShared_GetGamepadTargetingSensitivityPreset_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(LyraSettingsShared_eventGetGamepadTargetingSensitivityPreset_Parms, ReturnValue), Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity, METADATA_PARAMS(nullptr, 0) }; // 4008803939
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULyraSettingsShared_SetAllowAudioInBackgroundSetting_Statics::NewProp_NewValue = { "NewValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(LyraSettingsShared_eventSetAllowAudioInBackgroundSetting_Parms, NewValue), Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting, METADATA_PARAMS(nullptr, 0) }; // 1224005849
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraSettingsShared_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraSettingsShared_GetAllowAudioInBackgroundSetting, "GetAllowAudioInBackgroundSetting" }, // 753700404
		{ &Z_Construct_UFunction_ULyraSettingsShared_GetColorBlindMode, "GetColorBlindMode" }, // 729092781
		...
		{ &Z_Construct_UFunction_ULyraSettingsShared_GetGamepadLookSensitivityPreset, "GetGamepadLookSensitivityPreset" }, // 3137342955
		...
		{ &Z_Construct_UFunction_ULyraSettingsShared_GetGamepadTargetingSensitivityPreset, "GetGamepadTargetingSensitivityPreset" }, // 2568987070
		...
		{ &Z_Construct_UFunction_ULyraSettingsShared_SetAllowAudioInBackgroundSetting, "SetAllowAudioInBackgroundSetting" }, // 3286416304
		{ &Z_Construct_UFunction_ULyraSettingsShared_SetColorBlindMode, "SetColorBlindMode" }, // 2486499974
		...
		{ &Z_Construct_UFunction_ULyraSettingsShared_SetGamepadTargetingSensitivityPreset, "SetGamepadTargetingSensitivityPreset" }, // 3951510101
		...
		{ &Z_Construct_UFunction_ULyraSettingsShared_SetLookSensitivityPreset, "SetLookSensitivityPreset" }, // 114341462
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_ColorBlindMode = { "ColorBlindMode", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraSettingsShared, ColorBlindMode), Z_Construct_UEnum_SkyShooterGame_EColorBlindMode, METADATA_PARAMS(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_ColorBlindMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_ColorBlindMode_MetaData)) }; // 1903958863
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_AllowAudioInBackground = { "AllowAudioInBackground", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraSettingsShared, AllowAudioInBackground), Z_Construct_UEnum_SkyShooterGame_ELyraAllowBackgroundAudioSetting, METADATA_PARAMS(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_AllowAudioInBackground_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_AllowAudioInBackground_MetaData)) }; // 1224005849
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_GamepadLookSensitivityPreset = { "GamepadLookSensitivityPreset", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraSettingsShared, GamepadLookSensitivityPreset), Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity, METADATA_PARAMS(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_GamepadLookSensitivityPreset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_GamepadLookSensitivityPreset_MetaData)) }; // 4008803939
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_GamepadTargetingSensitivityPreset = { "GamepadTargetingSensitivityPreset", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraSettingsShared, GamepadTargetingSensitivityPreset), Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity, METADATA_PARAMS(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_GamepadTargetingSensitivityPreset_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraSettingsShared_Statics::NewProp_GamepadTargetingSensitivityPreset_MetaData)) }; // 4008803939
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraSettingsShared>()
	{
		return ULyraSettingsShared::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraSettingsShared);
	ULyraSettingsShared::~ULyraSettingsShared() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics::EnumInfo[] = {
		{ EColorBlindMode_StaticEnum, TEXT("EColorBlindMode"), &Z_Registration_Info_UEnum_EColorBlindMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1903958863U) },
		{ ELyraAllowBackgroundAudioSetting_StaticEnum, TEXT("ELyraAllowBackgroundAudioSetting"), &Z_Registration_Info_UEnum_ELyraAllowBackgroundAudioSetting, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1224005849U) },
		{ ELyraGamepadSensitivity_StaticEnum, TEXT("ELyraGamepadSensitivity"), &Z_Registration_Info_UEnum_ELyraGamepadSensitivity, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4008803939U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraSettingsShared, ULyraSettingsShared::StaticClass, TEXT("ULyraSettingsShared"), &Z_Registration_Info_UClass_ULyraSettingsShared, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraSettingsShared), 828515301U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_1741639145(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Settings_LyraSettingsShared_h_Statics::EnumInfo));
