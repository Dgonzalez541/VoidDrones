...
#include "SkyShooterGame/UI/Frontend/LyraLobbyBackground.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraLobbyBackground() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UPrimaryDataAsset();
	ENGINE_API UClass* Z_Construct_UClass_UWorld_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraLobbyBackground();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraLobbyBackground_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraLobbyBackground>()
	{
		return ULyraLobbyBackground::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraLobbyBackground);
	ULyraLobbyBackground::~ULyraLobbyBackground() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Frontend_LyraLobbyBackground_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Frontend_LyraLobbyBackground_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraLobbyBackground, ULyraLobbyBackground::StaticClass, TEXT("ULyraLobbyBackground"), &Z_Registration_Info_UClass_ULyraLobbyBackground, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraLobbyBackground), 3058435072U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Frontend_LyraLobbyBackground_h_1699211907(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Frontend_LyraLobbyBackground_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Frontend_LyraLobbyBackground_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
