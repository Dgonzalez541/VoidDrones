...
#include "SkyShooterGame/UI/LyraJoystickWidget.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraJoystickWidget() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FVector2D();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraJoystickWidget();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraJoystickWidget_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraJoystickWidget>()
	{
		return ULyraJoystickWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraJoystickWidget);
	ULyraJoystickWidget::~ULyraJoystickWidget() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraJoystickWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraJoystickWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraJoystickWidget, ULyraJoystickWidget::StaticClass, TEXT("ULyraJoystickWidget"), &Z_Registration_Info_UClass_ULyraJoystickWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraJoystickWidget), 1435599244U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraJoystickWidget_h_1207320994(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraJoystickWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraJoystickWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
