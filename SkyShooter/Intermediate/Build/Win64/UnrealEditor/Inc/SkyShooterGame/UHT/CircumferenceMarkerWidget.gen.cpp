...
#include "SkyShooterGame/UI/Weapons/CircumferenceMarkerWidget.h"
#include "SkyShooterGame/UI/Weapons/SCircumferenceMarkerWidget.h"
#include "SlateCore/Public/Styling/SlateBrush.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeCircumferenceMarkerWidget() {}
// Cross Module References
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UCircumferenceMarkerWidget();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UCircumferenceMarkerWidget_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FCircumferenceMarkerEntry();
...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UCircumferenceMarkerWidget_Statics::NewProp_MarkerList_Inner = { "MarkerList", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FCircumferenceMarkerEntry, METADATA_PARAMS(nullptr, 0) }; // 1435533118
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UCircumferenceMarkerWidget>()
	{
		return UCircumferenceMarkerWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UCircumferenceMarkerWidget);
	UCircumferenceMarkerWidget::~UCircumferenceMarkerWidget() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_CircumferenceMarkerWidget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_CircumferenceMarkerWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UCircumferenceMarkerWidget, UCircumferenceMarkerWidget::StaticClass, TEXT("UCircumferenceMarkerWidget"), &Z_Registration_Info_UClass_UCircumferenceMarkerWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UCircumferenceMarkerWidget), 3004929627U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_CircumferenceMarkerWidget_h_2309856700(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_CircumferenceMarkerWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_CircumferenceMarkerWidget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
