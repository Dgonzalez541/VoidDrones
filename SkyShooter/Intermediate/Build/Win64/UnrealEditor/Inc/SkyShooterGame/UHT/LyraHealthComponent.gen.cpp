...
#include "SkyShooterGame/Character/LyraHealthComponent.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraHealthComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraHealthComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraHealthSet_NoRegister();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraDeathState();
	SKYSHOOTERGAME_API UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature();
	SKYSHOOTERGAME_API UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature();
	UPackage* Z_Construct_UPackage__Script_SkyShooterGame();
// End Cross Module References
	struct Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics
	{
	...
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::NewProp_OwningActor = { "OwningActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventLyraHealth_DeathEvent_Parms, OwningActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::NewProp_OwningActor,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Character/LyraHealthComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame, nullptr, "LyraHealth_DeathEvent__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::_Script_SkyShooterGame_eventLyraHealth_DeathEvent_Parms), Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics
	{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_HealthComponent_MetaData[] = {
		{ "EditInline", "true" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_HealthComponent = { "HealthComponent", nullptr, (EPropertyFlags)0x0010000000080080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventLyraHealth_AttributeChanged_Parms, HealthComponent), Z_Construct_UClass_ULyraHealthComponent_NoRegister, METADATA_PARAMS(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_HealthComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_HealthComponent_MetaData)) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_OldValue = { "OldValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventLyraHealth_AttributeChanged_Parms, OldValue), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_NewValue = { "NewValue", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventLyraHealth_AttributeChanged_Parms, NewValue), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_Instigator = { "Instigator", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventLyraHealth_AttributeChanged_Parms, Instigator), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_HealthComponent,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_OldValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_NewValue,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::NewProp_Instigator,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Character/LyraHealthComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame, nullptr, "LyraHealth_AttributeChanged__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::_Script_SkyShooterGame_eventLyraHealth_AttributeChanged_Parms), Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	static UEnum* ELyraDeathState_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraDeathState.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraDeathState, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraDeathState"));
		}
	...
	struct Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraDeathState",
		"ELyraDeathState",
		Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraDeathState()
	{
		if (!Z_Registration_Info_UEnum_ELyraDeathState.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraDeathState.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraDeathState_Statics::EnumParams);
		}
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_ULyraHealthComponent_GetDeathState_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(LyraHealthComponent_eventGetDeathState_Parms, ReturnValue), Z_Construct_UEnum_SkyShooterGame_ELyraDeathState, METADATA_PARAMS(nullptr, 0) }; // 3154073271
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraHealthComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ULyraHealthComponent_GetDeathState, "GetDeathState" }, // 3953355885
		...
		{ &Z_Construct_UFunction_ULyraHealthComponent_OnRep_DeathState, "OnRep_DeathState" }, // 115055364
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnHealthChanged = { "OnHealthChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraHealthComponent, OnHealthChanged), Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnHealthChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnHealthChanged_MetaData)) }; // 3000331892
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnMaxHealthChanged = { "OnMaxHealthChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraHealthComponent, OnMaxHealthChanged), Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_AttributeChanged__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnMaxHealthChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnMaxHealthChanged_MetaData)) }; // 3000331892
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnDeathStarted = { "OnDeathStarted", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraHealthComponent, OnDeathStarted), Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnDeathStarted_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnDeathStarted_MetaData)) }; // 3825548648
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnDeathFinished = { "OnDeathFinished", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraHealthComponent, OnDeathFinished), Z_Construct_UDelegateFunction_SkyShooterGame_LyraHealth_DeathEvent__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnDeathFinished_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_OnDeathFinished_MetaData)) }; // 3825548648
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_DeathState = { "DeathState", "OnRep_DeathState", (EPropertyFlags)0x0020080100000020, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraHealthComponent, DeathState), Z_Construct_UEnum_SkyShooterGame_ELyraDeathState, METADATA_PARAMS(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_DeathState_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraHealthComponent_Statics::NewProp_DeathState_MetaData)) }; // 3154073271
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraHealthComponent>()
	{
		return ULyraHealthComponent::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics::EnumInfo[] = {
		{ ELyraDeathState_StaticEnum, TEXT("ELyraDeathState"), &Z_Registration_Info_UEnum_ELyraDeathState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3154073271U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraHealthComponent, ULyraHealthComponent::StaticClass, TEXT("ULyraHealthComponent"), &Z_Registration_Info_UClass_ULyraHealthComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraHealthComponent), 1306403633U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_3414737418(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraHealthComponent_h_Statics::EnumInfo));
