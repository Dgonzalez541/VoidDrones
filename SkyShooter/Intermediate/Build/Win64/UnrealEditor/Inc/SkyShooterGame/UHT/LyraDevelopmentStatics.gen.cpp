...
#include "SkyShooterGame/System/LyraDevelopmentStatics.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraDevelopmentStatics() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UBlueprintFunctionLibrary();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDevelopmentStatics();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDevelopmentStatics_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraDevelopmentStatics>()
	{
		return ULyraDevelopmentStatics::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraDevelopmentStatics);
	ULyraDevelopmentStatics::~ULyraDevelopmentStatics() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraDevelopmentStatics_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraDevelopmentStatics_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraDevelopmentStatics, ULyraDevelopmentStatics::StaticClass, TEXT("ULyraDevelopmentStatics"), &Z_Registration_Info_UClass_ULyraDevelopmentStatics, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraDevelopmentStatics), 3710684734U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraDevelopmentStatics_h_547399010(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraDevelopmentStatics_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraDevelopmentStatics_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
