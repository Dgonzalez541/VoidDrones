...
#include "SkyShooterGame/Camera/LyraCameraMode.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraMode();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraMode_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraModeStack();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraModeStack_NoRegister();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction();
...
// End Cross Module References
	...
	static UEnum* ELyraCameraModeBlendFunction_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraCameraModeBlendFunction.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraCameraModeBlendFunction"));
		}
	...
	struct Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraCameraModeBlendFunction",
		"ELyraCameraModeBlendFunction",
		Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction()
	{
		if (!Z_Registration_Info_UEnum_ELyraCameraModeBlendFunction.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraCameraModeBlendFunction.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction_Statics::EnumParams);
		}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraCameraMode_Statics::NewProp_BlendFunction = { "BlendFunction", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraCameraMode, BlendFunction), Z_Construct_UEnum_SkyShooterGame_ELyraCameraModeBlendFunction, METADATA_PARAMS(Z_Construct_UClass_ULyraCameraMode_Statics::NewProp_BlendFunction_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraCameraMode_Statics::NewProp_BlendFunction_MetaData)) }; // 101213763
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraCameraMode>()
	{
		return ULyraCameraMode::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraCameraModeStack>()
	{
		return ULyraCameraModeStack::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraCameraModeStack);
	ULyraCameraModeStack::~ULyraCameraModeStack() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics::EnumInfo[] = {
		{ ELyraCameraModeBlendFunction_StaticEnum, TEXT("ELyraCameraModeBlendFunction"), &Z_Registration_Info_UEnum_ELyraCameraModeBlendFunction, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 101213763U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraCameraMode, ULyraCameraMode::StaticClass, TEXT("ULyraCameraMode"), &Z_Registration_Info_UClass_ULyraCameraMode, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraCameraMode), 3738234598U) },
		{ Z_Construct_UClass_ULyraCameraModeStack, ULyraCameraModeStack::StaticClass, TEXT("ULyraCameraModeStack"), &Z_Registration_Info_UClass_ULyraCameraModeStack, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraCameraModeStack), 3812268491U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_2720055502(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraMode_h_Statics::EnumInfo));
