...
#include "SkyShooterGame/Player/LyraPlayerBotController.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraPlayerBotController();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraPlayerBotController_NoRegister();
...
// End Cross Module References
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALyraPlayerBotController_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ALyraPlayerBotController_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULyraTeamAgentInterface_NoRegister, (int32)VTABLE_OFFSET(ALyraPlayerBotController, ILyraTeamAgentInterface), false },  // 3557573541
		};
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraPlayerBotController>()
	{
		return ALyraPlayerBotController::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALyraPlayerBotController);
	ALyraPlayerBotController::~ALyraPlayerBotController() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerBotController_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerBotController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraPlayerBotController, ALyraPlayerBotController::StaticClass, TEXT("ALyraPlayerBotController"), &Z_Registration_Info_UClass_ALyraPlayerBotController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraPlayerBotController), 2753130217U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerBotController_h_3709576(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerBotController_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Player_LyraPlayerBotController_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
