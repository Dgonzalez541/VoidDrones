...
#include "SkyShooterGame/Audio/LyraAudioSettings.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAudioSettings();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAudioSettings_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraSubmixEffectChainMap();
...
class UScriptStruct* FLyraSubmixEffectChainMap::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraSubmixEffectChainMap.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraSubmixEffectChainMap, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraSubmixEffectChainMap"));
	}
	return Z_Registration_Info_UScriptStruct_LyraSubmixEffectChainMap.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraSubmixEffectChainMap>()
{
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraAudioSettings>()
	{
		return ULyraAudioSettings::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraAudioSettings);
	ULyraAudioSettings::~ULyraAudioSettings() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics::ScriptStructInfo[] = {
		{ FLyraSubmixEffectChainMap::StaticStruct, Z_Construct_UScriptStruct_FLyraSubmixEffectChainMap_Statics::NewStructOps, TEXT("LyraSubmixEffectChainMap"), &Z_Registration_Info_UScriptStruct_LyraSubmixEffectChainMap, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraSubmixEffectChainMap), 3081847382U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraAudioSettings, ULyraAudioSettings::StaticClass, TEXT("ULyraAudioSettings"), &Z_Registration_Info_UClass_ULyraAudioSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraAudioSettings), 986869620U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_1502404611(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Audio_LyraAudioSettings_h_Statics::ScriptStructInfo),
		nullptr, 0);
