...
#include "SkyShooterGame/AbilitySystem/Executions/LyraHealExecution.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraHealExecution() {}
// Cross Module References
	GAMEPLAYABILITIES_API UClass* Z_Construct_UClass_UGameplayEffectExecutionCalculation();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraHealExecution();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraHealExecution_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraHealExecution>()
	{
		return ULyraHealExecution::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraHealExecution);
	ULyraHealExecution::~ULyraHealExecution() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraHealExecution_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraHealExecution_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraHealExecution, ULyraHealExecution::StaticClass, TEXT("ULyraHealExecution"), &Z_Registration_Info_UClass_ULyraHealExecution, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraHealExecution), 1545772464U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraHealExecution_h_96269288(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraHealExecution_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraHealExecution_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
