...
#include "SkyShooterGame/Weapons/LyraRangedWeaponInstance.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAbilitySourceInterface_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraRangedWeaponInstance();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraRangedWeaponInstance_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraWeaponInstance();
...
// End Cross Module References
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULyraRangedWeaponInstance_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ULyraRangedWeaponInstance_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULyraAbilitySourceInterface_NoRegister, (int32)VTABLE_OFFSET(ULyraRangedWeaponInstance, ILyraAbilitySourceInterface), false },  // 567815144
		};
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraRangedWeaponInstance>()
	{
		return ULyraRangedWeaponInstance::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraRangedWeaponInstance);
	ULyraRangedWeaponInstance::~ULyraRangedWeaponInstance() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_LyraRangedWeaponInstance_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_LyraRangedWeaponInstance_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraRangedWeaponInstance, ULyraRangedWeaponInstance::StaticClass, TEXT("ULyraRangedWeaponInstance"), &Z_Registration_Info_UClass_ULyraRangedWeaponInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraRangedWeaponInstance), 2438138873U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_LyraRangedWeaponInstance_h_3806419609(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_LyraRangedWeaponInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_LyraRangedWeaponInstance_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
