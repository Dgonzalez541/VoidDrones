...
#include "SkyShooterGame/AbilitySystem/LyraGameplayAbilityTargetData_SingleTargetHit.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraGameplayAbilityTargetData_SingleTargetHit();
...
class UScriptStruct* FLyraGameplayAbilityTargetData_SingleTargetHit::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraGameplayAbilityTargetData_SingleTargetHit.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraGameplayAbilityTargetData_SingleTargetHit, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraGameplayAbilityTargetData_SingleTargetHit"));
	}
	return Z_Registration_Info_UScriptStruct_LyraGameplayAbilityTargetData_SingleTargetHit.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraGameplayAbilityTargetData_SingleTargetHit>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics::ScriptStructInfo[] = {
		{ FLyraGameplayAbilityTargetData_SingleTargetHit::StaticStruct, Z_Construct_UScriptStruct_FLyraGameplayAbilityTargetData_SingleTargetHit_Statics::NewStructOps, TEXT("LyraGameplayAbilityTargetData_SingleTargetHit"), &Z_Registration_Info_UScriptStruct_LyraGameplayAbilityTargetData_SingleTargetHit, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraGameplayAbilityTargetData_SingleTargetHit), 69678611U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_3611957756(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayAbilityTargetData_SingleTargetHit_h_Statics::ScriptStructInfo),
		nullptr, 0);
