...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLoadedMappableConfigPair();
...
class UScriptStruct* FLoadedMappableConfigPair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LoadedMappableConfigPair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLoadedMappableConfigPair, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LoadedMappableConfigPair"));
	}
	return Z_Registration_Info_UScriptStruct_LoadedMappableConfigPair.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLoadedMappableConfigPair>()
{
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_Config = { "Config", nullptr, (EPropertyFlags)0x0014000000020015, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FLoadedMappableConfigPair, Config), Z_Construct_UClass_UPlayerMappableInputConfig_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_Config_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_Config_MetaData)) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FLoadedMappableConfigPair, Type), Z_Construct_UEnum_CommonInput_ECommonInputType, METADATA_PARAMS(Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_Type_MetaData)) }; // 3567225506
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_bIsActive = { "bIsActive", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(FLoadedMappableConfigPair), &Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_bIsActive_SetBit, METADATA_PARAMS(Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_bIsActive_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewProp_bIsActive_MetaData)) };
...
class UScriptStruct* FMappableConfigPair::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_MappableConfigPair.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FMappableConfigPair, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("MappableConfigPair"));
	}
	return Z_Registration_Info_UScriptStruct_MappableConfigPair.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FMappableConfigPair>()
{
...
#endif
	const UECodeGen_Private::FSoftObjectPropertyParams Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Config = { "Config", nullptr, (EPropertyFlags)0x0014000000000001, UECodeGen_Private::EPropertyGenFlags::SoftObject, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMappableConfigPair, Config), Z_Construct_UClass_UPlayerMappableInputConfig_NoRegister, METADATA_PARAMS(Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Config_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Config_MetaData)) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Type_Underlying = { "UnderlyingType", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, nullptr, METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Type = { "Type", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMappableConfigPair, Type), Z_Construct_UEnum_CommonInput_ECommonInputType, METADATA_PARAMS(Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Type_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_Type_MetaData)) }; // 3567225506
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_ExcludedPlatformTraits = { "ExcludedPlatformTraits", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FMappableConfigPair, ExcludedPlatformTraits), Z_Construct_UScriptStruct_FGameplayTagContainer, METADATA_PARAMS(Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_ExcludedPlatformTraits_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewProp_ExcludedPlatformTraits_MetaData)) }; // 3057219007
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraMappableConfigPair_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraMappableConfigPair_h_Statics::ScriptStructInfo[] = {
		{ FLoadedMappableConfigPair::StaticStruct, Z_Construct_UScriptStruct_FLoadedMappableConfigPair_Statics::NewStructOps, TEXT("LoadedMappableConfigPair"), &Z_Registration_Info_UScriptStruct_LoadedMappableConfigPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLoadedMappableConfigPair), 3719256767U) },
		{ FMappableConfigPair::StaticStruct, Z_Construct_UScriptStruct_FMappableConfigPair_Statics::NewStructOps, TEXT("MappableConfigPair"), &Z_Registration_Info_UScriptStruct_MappableConfigPair, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMappableConfigPair), 1436150531U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraMappableConfigPair_h_2561637041(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraMappableConfigPair_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraMappableConfigPair_h_Statics::ScriptStructInfo),
		nullptr, 0);
