...
#include "SkyShooterGame/UI/IndicatorSystem/IndicatorDescriptor.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UIndicatorDescriptor();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UIndicatorDescriptor_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraIndicatorManagerComponent_NoRegister();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode();
...
// End Cross Module References
	...
	static UEnum* EActorCanvasProjectionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_EActorCanvasProjectionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("EActorCanvasProjectionMode"));
		}
		return Z_Registration_Info_UEnum_EActorCanvasProjectionMode.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<EActorCanvasProjectionMode>()
	{
		return EActorCanvasProjectionMode_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::Enum_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"EActorCanvasProjectionMode",
		"EActorCanvasProjectionMode",
		Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode()
	{
		if (!Z_Registration_Info_UEnum_EActorCanvasProjectionMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_EActorCanvasProjectionMode.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode_Statics::EnumParams);
		}
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UFunction_UIndicatorDescriptor_GetProjectionMode_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(IndicatorDescriptor_eventGetProjectionMode_Parms, ReturnValue), Z_Construct_UEnum_SkyShooterGame_EActorCanvasProjectionMode, METADATA_PARAMS(nullptr, 0) }; // 797501584
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UIndicatorDescriptor_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_UIndicatorDescriptor_GetProjectionMode, "GetProjectionMode" }, // 2628315118
		...
		{ &Z_Construct_UFunction_UIndicatorDescriptor_SetProjectionMode, "SetProjectionMode" }, // 1865304963
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UIndicatorDescriptor>()
	{
		return UIndicatorDescriptor::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UIndicatorDescriptor);
	UIndicatorDescriptor::~UIndicatorDescriptor() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics::EnumInfo[] = {
		{ EActorCanvasProjectionMode_StaticEnum, TEXT("EActorCanvasProjectionMode"), &Z_Registration_Info_UEnum_EActorCanvasProjectionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 797501584U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIndicatorDescriptor, UIndicatorDescriptor::StaticClass, TEXT("UIndicatorDescriptor"), &Z_Registration_Info_UClass_UIndicatorDescriptor, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIndicatorDescriptor), 2681402462U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_586229060(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorDescriptor_h_Statics::EnumInfo));
