...
#include "SkyShooterGame/GameFeatures/GameFeatureAction_AddWidget.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_AddWidgets();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_AddWidgets_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_WorldActionBase();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraHUDElementEntry();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraHUDLayoutRequest();
...
class UScriptStruct* FLyraHUDLayoutRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraHUDLayoutRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraHUDLayoutRequest, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraHUDLayoutRequest"));
	}
	return Z_Registration_Info_UScriptStruct_LyraHUDLayoutRequest.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraHUDLayoutRequest>()
{
...
class UScriptStruct* FLyraHUDElementEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraHUDElementEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraHUDElementEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraHUDElementEntry"));
	}
	return Z_Registration_Info_UScriptStruct_LyraHUDElementEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraHUDElementEntry>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameFeatureAction_AddWidgets_Statics::NewProp_Layout_Inner = { "Layout", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FLyraHUDLayoutRequest, METADATA_PARAMS(nullptr, 0) }; // 3506528815
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UGameFeatureAction_AddWidgets>()
	{
		return UGameFeatureAction_AddWidgets::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UGameFeatureAction_AddWidgets);
	UGameFeatureAction_AddWidgets::~UGameFeatureAction_AddWidgets() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ScriptStructInfo[] = {
		{ FLyraHUDLayoutRequest::StaticStruct, Z_Construct_UScriptStruct_FLyraHUDLayoutRequest_Statics::NewStructOps, TEXT("LyraHUDLayoutRequest"), &Z_Registration_Info_UScriptStruct_LyraHUDLayoutRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraHUDLayoutRequest), 3506528815U) },
		{ FLyraHUDElementEntry::StaticStruct, Z_Construct_UScriptStruct_FLyraHUDElementEntry_Statics::NewStructOps, TEXT("LyraHUDElementEntry"), &Z_Registration_Info_UScriptStruct_LyraHUDElementEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraHUDElementEntry), 1182130684U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_AddWidgets, UGameFeatureAction_AddWidgets::StaticClass, TEXT("UGameFeatureAction_AddWidgets"), &Z_Registration_Info_UClass_UGameFeatureAction_AddWidgets, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_AddWidgets), 3390806230U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_2485599957(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddWidget_h_Statics::ScriptStructInfo),
		nullptr, 0);
