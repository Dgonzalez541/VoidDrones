...
#include "SkyShooterGame/GameModes/LyraExperienceManager.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraExperienceManager() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UEngineSubsystem();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraExperienceManager();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraExperienceManager_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraExperienceManager>()
	{
		return ULyraExperienceManager::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraExperienceManager);
	ULyraExperienceManager::~ULyraExperienceManager() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraExperienceManager_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraExperienceManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraExperienceManager, ULyraExperienceManager::StaticClass, TEXT("ULyraExperienceManager"), &Z_Registration_Info_UClass_ULyraExperienceManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraExperienceManager), 4144971643U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraExperienceManager_h_720272860(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraExperienceManager_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraExperienceManager_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
