...
#include "SkyShooterGame/Inventory/LyraInventoryItemDefinition.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryFunctionLibrary();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryFunctionLibrary_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemDefinition();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemDefinition_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemFragment();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemFragment_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraInventoryItemFragment>()
	{
		return ULyraInventoryItemFragment::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraInventoryItemDefinition>()
	{
		return ULyraInventoryItemDefinition::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraInventoryFunctionLibrary>()
	{
		return ULyraInventoryFunctionLibrary::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraInventoryFunctionLibrary);
	ULyraInventoryFunctionLibrary::~ULyraInventoryFunctionLibrary() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryItemDefinition_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryItemDefinition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraInventoryItemFragment, ULyraInventoryItemFragment::StaticClass, TEXT("ULyraInventoryItemFragment"), &Z_Registration_Info_UClass_ULyraInventoryItemFragment, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraInventoryItemFragment), 2229959353U) },
		{ Z_Construct_UClass_ULyraInventoryItemDefinition, ULyraInventoryItemDefinition::StaticClass, TEXT("ULyraInventoryItemDefinition"), &Z_Registration_Info_UClass_ULyraInventoryItemDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraInventoryItemDefinition), 3147147337U) },
		{ Z_Construct_UClass_ULyraInventoryFunctionLibrary, ULyraInventoryFunctionLibrary::StaticClass, TEXT("ULyraInventoryFunctionLibrary"), &Z_Registration_Info_UClass_ULyraInventoryFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraInventoryFunctionLibrary), 497986145U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryItemDefinition_h_2175427791(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryItemDefinition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryItemDefinition_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
