...
#include "SkyShooterGame/Inventory/InventoryFragment_SetStats.h"
#include "GameplayTags/Classes/GameplayTagContainer.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeInventoryFragment_SetStats() {}
// Cross Module References
	GAMEPLAYTAGS_API UScriptStruct* Z_Construct_UScriptStruct_FGameplayTag();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInventoryFragment_SetStats();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInventoryFragment_SetStats_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UInventoryFragment_SetStats>()
	{
		return UInventoryFragment_SetStats::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UInventoryFragment_SetStats);
	UInventoryFragment_SetStats::~UInventoryFragment_SetStats() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_SetStats_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_SetStats_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInventoryFragment_SetStats, UInventoryFragment_SetStats::StaticClass, TEXT("UInventoryFragment_SetStats"), &Z_Registration_Info_UClass_UInventoryFragment_SetStats, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInventoryFragment_SetStats), 721306193U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_SetStats_h_3665387685(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_SetStats_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_SetStats_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
