...
#include "SkyShooterGame/Character/LyraCharacter.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraCharacter();
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraPlayerState_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAbilitySystemComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraHealthComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPawnExtensionComponent_NoRegister();
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraReplicatedAcceleration();
...
class UScriptStruct* FLyraReplicatedAcceleration::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraReplicatedAcceleration.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraReplicatedAcceleration, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraReplicatedAcceleration"));
	}
	return Z_Registration_Info_UScriptStruct_LyraReplicatedAcceleration.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraReplicatedAcceleration>()
{
...
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_ManaComponent;
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_ChargeComponent_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPtrPropertyParams NewProp_ChargeComponent;
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ManaComponent_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Lyra|Character" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Character/LyraCharacter.h" },
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ManaComponent = { "ManaComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ALyraCharacter, ManaComponent), Z_Construct_UClass_UManaComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ManaComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ManaComponent_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ChargeComponent_MetaData[] = {
		{ "AllowPrivateAccess", "true" },
		{ "Category", "Lyra|Character" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Character/LyraCharacter.h" },
...
#endif
	const UECodeGen_Private::FObjectPtrPropertyParams Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ChargeComponent = { "ChargeComponent", nullptr, (EPropertyFlags)0x00440000000a001d, UECodeGen_Private::EPropertyGenFlags::Object | UECodeGen_Private::EPropertyGenFlags::ObjectPtr, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ALyraCharacter, ChargeComponent), Z_Construct_UClass_UChargeComponent_NoRegister, METADATA_PARAMS(Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ChargeComponent_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ChargeComponent_MetaData)) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ALyraCharacter_Statics::NewProp_OnTeamChangedDelegate = { "OnTeamChangedDelegate", nullptr, (EPropertyFlags)0x0040000000080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ALyraCharacter, OnTeamChangedDelegate), Z_Construct_UDelegateFunction_SkyShooterGame_OnLyraTeamIndexChangedDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ALyraCharacter_Statics::NewProp_OnTeamChangedDelegate_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ALyraCharacter_Statics::NewProp_OnTeamChangedDelegate_MetaData)) }; // 148292558
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ALyraCharacter_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ManaComponent,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ALyraCharacter_Statics::NewProp_ChargeComponent,
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ALyraCharacter_Statics::InterfaceParams[] = {
			...
			{ Z_Construct_UClass_ULyraTeamAgentInterface_NoRegister, (int32)VTABLE_OFFSET(ALyraCharacter, ILyraTeamAgentInterface), false },  // 3557573541
		};
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraCharacter>()
	{
		return ALyraCharacter::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics::ScriptStructInfo[] = {
		{ FLyraReplicatedAcceleration::StaticStruct, Z_Construct_UScriptStruct_FLyraReplicatedAcceleration_Statics::NewStructOps, TEXT("LyraReplicatedAcceleration"), &Z_Registration_Info_UScriptStruct_LyraReplicatedAcceleration, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraReplicatedAcceleration), 218432995U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraCharacter, ALyraCharacter::StaticClass, TEXT("ALyraCharacter"), &Z_Registration_Info_UClass_ALyraCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraCharacter), 3192729408U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_2535339713(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Character_LyraCharacter_h_Statics::ScriptStructInfo),
		nullptr, 0);
