...
class UScriptStruct* FCircumferenceMarkerEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_CircumferenceMarkerEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FCircumferenceMarkerEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("CircumferenceMarkerEntry"));
	}
	return Z_Registration_Info_UScriptStruct_CircumferenceMarkerEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FCircumferenceMarkerEntry>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics::ScriptStructInfo[] = {
		{ FCircumferenceMarkerEntry::StaticStruct, Z_Construct_UScriptStruct_FCircumferenceMarkerEntry_Statics::NewStructOps, TEXT("CircumferenceMarkerEntry"), &Z_Registration_Info_UScriptStruct_CircumferenceMarkerEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FCircumferenceMarkerEntry), 1435533118U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_SCircumferenceMarkerWidget_h_462556350(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_SCircumferenceMarkerWidget_h_Statics::ScriptStructInfo),
		nullptr, 0);
