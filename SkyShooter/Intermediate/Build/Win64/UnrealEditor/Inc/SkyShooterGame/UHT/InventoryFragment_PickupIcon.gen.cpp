...
#include "SkyShooterGame/Inventory/InventoryFragment_PickupIcon.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeInventoryFragment_PickupIcon() {}
// Cross Module References
	COREUOBJECT_API UScriptStruct* Z_Construct_UScriptStruct_FLinearColor();
	ENGINE_API UClass* Z_Construct_UClass_USkeletalMesh_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInventoryFragment_PickupIcon();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInventoryFragment_PickupIcon_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UInventoryFragment_PickupIcon>()
	{
		return UInventoryFragment_PickupIcon::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UInventoryFragment_PickupIcon);
	UInventoryFragment_PickupIcon::~UInventoryFragment_PickupIcon() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_PickupIcon_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_PickupIcon_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInventoryFragment_PickupIcon, UInventoryFragment_PickupIcon::StaticClass, TEXT("UInventoryFragment_PickupIcon"), &Z_Registration_Info_UClass_UInventoryFragment_PickupIcon, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInventoryFragment_PickupIcon), 348164667U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_PickupIcon_h_124762108(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_PickupIcon_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_InventoryFragment_PickupIcon_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
