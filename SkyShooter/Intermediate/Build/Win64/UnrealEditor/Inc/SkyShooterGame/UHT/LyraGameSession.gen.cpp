...
#include "SkyShooterGame/System/LyraGameSession.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraGameSession() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AGameSession();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraGameSession();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraGameSession_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraGameSession>()
	{
		return ALyraGameSession::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALyraGameSession);
	ALyraGameSession::~ALyraGameSession() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameSession_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameSession_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraGameSession, ALyraGameSession::StaticClass, TEXT("ALyraGameSession"), &Z_Registration_Info_UClass_ALyraGameSession, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraGameSession), 4151073405U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameSession_h_1627157500(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameSession_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameSession_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
