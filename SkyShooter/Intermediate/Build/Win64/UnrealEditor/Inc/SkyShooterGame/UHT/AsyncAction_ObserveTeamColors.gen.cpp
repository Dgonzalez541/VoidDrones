...
#include "SkyShooterGame/Teams/AsyncAction_ObserveTeamColors.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UAsyncAction_ObserveTeamColors();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UAsyncAction_ObserveTeamColors_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTeamDisplayAsset_NoRegister();
	SKYSHOOTERGAME_API UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature();
	UPackage* Z_Construct_UPackage__Script_SkyShooterGame();
// End Cross Module References
	struct Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics
	{
	...
	void Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_bTeamSet_SetBit(void* Obj)
	{
		((_Script_SkyShooterGame_eventTeamColorObservedAsyncDelegate_Parms*)Obj)->bTeamSet = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_bTeamSet = { "bTeamSet", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(_Script_SkyShooterGame_eventTeamColorObservedAsyncDelegate_Parms), &Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_bTeamSet_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_TeamId = { "TeamId", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventTeamColorObservedAsyncDelegate_Parms, TeamId), METADATA_PARAMS(nullptr, 0) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_DisplayAsset_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_DisplayAsset = { "DisplayAsset", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventTeamColorObservedAsyncDelegate_Parms, DisplayAsset), Z_Construct_UClass_ULyraTeamDisplayAsset_NoRegister, METADATA_PARAMS(Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_DisplayAsset_MetaData, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_DisplayAsset_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_bTeamSet,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_TeamId,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::NewProp_DisplayAsset,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "Teams/AsyncAction_ObserveTeamColors.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame, nullptr, "TeamColorObservedAsyncDelegate__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::_Script_SkyShooterGame_eventTeamColorObservedAsyncDelegate_Parms), Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature_Statics::FuncParams);
		}
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_UAsyncAction_ObserveTeamColors_Statics::NewProp_OnTeamChanged = { "OnTeamChanged", nullptr, (EPropertyFlags)0x0010000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(UAsyncAction_ObserveTeamColors, OnTeamChanged), Z_Construct_UDelegateFunction_SkyShooterGame_TeamColorObservedAsyncDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_UAsyncAction_ObserveTeamColors_Statics::NewProp_OnTeamChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UAsyncAction_ObserveTeamColors_Statics::NewProp_OnTeamChanged_MetaData)) }; // 3960883668
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UAsyncAction_ObserveTeamColors>()
	{
		return UAsyncAction_ObserveTeamColors::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Teams_AsyncAction_ObserveTeamColors_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Teams_AsyncAction_ObserveTeamColors_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAsyncAction_ObserveTeamColors, UAsyncAction_ObserveTeamColors::StaticClass, TEXT("UAsyncAction_ObserveTeamColors"), &Z_Registration_Info_UClass_UAsyncAction_ObserveTeamColors, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAsyncAction_ObserveTeamColors), 2840694947U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Teams_AsyncAction_ObserveTeamColors_h_4087430126(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Teams_AsyncAction_ObserveTeamColors_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Teams_AsyncAction_ObserveTeamColors_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
