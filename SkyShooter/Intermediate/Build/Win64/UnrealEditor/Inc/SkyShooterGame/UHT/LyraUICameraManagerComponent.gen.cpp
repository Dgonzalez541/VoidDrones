...
#include "SkyShooterGame/Camera/LyraUICameraManagerComponent.h"
#include "SkyShooterGame/Camera/LyraPlayerCameraManager.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraUICameraManagerComponent() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_UActorComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraUICameraManagerComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraUICameraManagerComponent_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraUICameraManagerComponent>()
	{
		return ULyraUICameraManagerComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraUICameraManagerComponent);
	ULyraUICameraManagerComponent::~ULyraUICameraManagerComponent() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraUICameraManagerComponent_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraUICameraManagerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraUICameraManagerComponent, ULyraUICameraManagerComponent::StaticClass, TEXT("ULyraUICameraManagerComponent"), &Z_Registration_Info_UClass_ULyraUICameraManagerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraUICameraManagerComponent), 3983648792U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraUICameraManagerComponent_h_1749730521(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraUICameraManagerComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraUICameraManagerComponent_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
