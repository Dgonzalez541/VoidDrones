...
#include "SkyShooterGame/Weapons/InventoryFragment_ReticleConfig.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeInventoryFragment_ReticleConfig() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UClass();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInventoryFragment_ReticleConfig();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInventoryFragment_ReticleConfig_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemFragment();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReticleWidgetBase_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UInventoryFragment_ReticleConfig>()
	{
		return UInventoryFragment_ReticleConfig::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_InventoryFragment_ReticleConfig_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_InventoryFragment_ReticleConfig_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInventoryFragment_ReticleConfig, UInventoryFragment_ReticleConfig::StaticClass, TEXT("UInventoryFragment_ReticleConfig"), &Z_Registration_Info_UClass_UInventoryFragment_ReticleConfig, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInventoryFragment_ReticleConfig), 4280883462U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_InventoryFragment_ReticleConfig_h_3584004548(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_InventoryFragment_ReticleConfig_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Weapons_InventoryFragment_ReticleConfig_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
