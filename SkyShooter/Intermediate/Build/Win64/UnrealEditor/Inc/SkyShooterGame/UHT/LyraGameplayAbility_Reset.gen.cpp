...
#include "SkyShooterGame/AbilitySystem/Abilities/LyraGameplayAbility_Reset.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraGameplayAbility_Reset();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraGameplayAbility_Reset_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraPlayerResetMessage();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraGameplayAbility_Reset>()
	{
		return ULyraGameplayAbility_Reset::StaticClass();
	}
...
class UScriptStruct* FLyraPlayerResetMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraPlayerResetMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraPlayerResetMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraPlayerResetMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraPlayerResetMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraPlayerResetMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ScriptStructInfo[] = {
		{ FLyraPlayerResetMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraPlayerResetMessage_Statics::NewStructOps, TEXT("LyraPlayerResetMessage"), &Z_Registration_Info_UScriptStruct_LyraPlayerResetMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraPlayerResetMessage), 1754740652U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraGameplayAbility_Reset, ULyraGameplayAbility_Reset::StaticClass, TEXT("ULyraGameplayAbility_Reset"), &Z_Registration_Info_UClass_ULyraGameplayAbility_Reset, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraGameplayAbility_Reset), 1816111453U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_4280846932(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraGameplayAbility_Reset_h_Statics::ScriptStructInfo),
		nullptr, 0);
