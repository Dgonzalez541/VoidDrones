...
#include "SkyShooterGame/Feedback/NumberPops/LyraDamagePopStyleNiagara.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraDamagePopStyleNiagara() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UDataAsset();
	NIAGARA_API UClass* Z_Construct_UClass_UNiagaraSystem_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDamagePopStyleNiagara();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraDamagePopStyleNiagara>()
	{
		return ULyraDamagePopStyleNiagara::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraDamagePopStyleNiagara);
	ULyraDamagePopStyleNiagara::~ULyraDamagePopStyleNiagara() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraDamagePopStyleNiagara_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraDamagePopStyleNiagara_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraDamagePopStyleNiagara, ULyraDamagePopStyleNiagara::StaticClass, TEXT("ULyraDamagePopStyleNiagara"), &Z_Registration_Info_UClass_ULyraDamagePopStyleNiagara, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraDamagePopStyleNiagara), 3314562854U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraDamagePopStyleNiagara_h_2659746669(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraDamagePopStyleNiagara_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraDamagePopStyleNiagara_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
