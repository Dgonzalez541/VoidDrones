...
#include "SkyShooterGame/GameFeatures/GameFeatureAction_AddAbilities.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_AddAbilities();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_AddAbilities_NoRegister();
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FGameFeatureAbilitiesEntry();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraAbilityGrant();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraAttributeSetGrant();
...
class UScriptStruct* FLyraAbilityGrant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilityGrant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilityGrant, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraAbilityGrant"));
	}
	return Z_Registration_Info_UScriptStruct_LyraAbilityGrant.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraAbilityGrant>()
{
...
class UScriptStruct* FLyraAttributeSetGrant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAttributeSetGrant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAttributeSetGrant, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraAttributeSetGrant"));
	}
	return Z_Registration_Info_UScriptStruct_LyraAttributeSetGrant.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraAttributeSetGrant>()
{
...
class UScriptStruct* FGameFeatureAbilitiesEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameFeatureAbilitiesEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameFeatureAbilitiesEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("GameFeatureAbilitiesEntry"));
	}
	return Z_Registration_Info_UScriptStruct_GameFeatureAbilitiesEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FGameFeatureAbilitiesEntry>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameFeatureAbilitiesEntry_Statics::NewProp_GrantedAbilities_Inner = { "GrantedAbilities", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FLyraAbilityGrant, METADATA_PARAMS(nullptr, 0) }; // 336202131
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UGameFeatureAction_AddAbilities>()
	{
		return UGameFeatureAction_AddAbilities::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ScriptStructInfo[] = {
		{ FLyraAbilityGrant::StaticStruct, Z_Construct_UScriptStruct_FLyraAbilityGrant_Statics::NewStructOps, TEXT("LyraAbilityGrant"), &Z_Registration_Info_UScriptStruct_LyraAbilityGrant, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraAbilityGrant), 336202131U) },
		{ FLyraAttributeSetGrant::StaticStruct, Z_Construct_UScriptStruct_FLyraAttributeSetGrant_Statics::NewStructOps, TEXT("LyraAttributeSetGrant"), &Z_Registration_Info_UScriptStruct_LyraAttributeSetGrant, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraAttributeSetGrant), 2130722063U) },
		{ FGameFeatureAbilitiesEntry::StaticStruct, Z_Construct_UScriptStruct_FGameFeatureAbilitiesEntry_Statics::NewStructOps, TEXT("GameFeatureAbilitiesEntry"), &Z_Registration_Info_UScriptStruct_GameFeatureAbilitiesEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameFeatureAbilitiesEntry), 2808248627U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_AddAbilities, UGameFeatureAction_AddAbilities::StaticClass, TEXT("UGameFeatureAction_AddAbilities"), &Z_Registration_Info_UClass_UGameFeatureAction_AddAbilities, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_AddAbilities), 2144244805U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_3314775116(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddAbilities_h_Statics::ScriptStructInfo),
		nullptr, 0);
