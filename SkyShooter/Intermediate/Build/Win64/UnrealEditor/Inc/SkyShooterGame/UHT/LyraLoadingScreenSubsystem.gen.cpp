...
#include "SkyShooterGame/UI/Foundation/LyraLoadingScreenSubsystem.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraLoadingScreenSubsystem();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraLoadingScreenSubsystem_NoRegister();
	SKYSHOOTERGAME_API UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature();
	UMG_API UClass* Z_Construct_UClass_UUserWidget_NoRegister();
	UPackage* Z_Construct_UPackage__Script_SkyShooterGame();
// End Cross Module References
	struct Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics
	{
	...
	const UECodeGen_Private::FClassPropertyParams Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::NewProp_NewWidgetClass = { "NewWidgetClass", nullptr, (EPropertyFlags)0x0014000000000080, UECodeGen_Private::EPropertyGenFlags::Class, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(_Script_SkyShooterGame_eventLoadingScreenWidgetChangedDelegate_Parms, NewWidgetClass), Z_Construct_UClass_UClass, Z_Construct_UClass_UUserWidget_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::NewProp_NewWidgetClass,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "UI/Foundation/LyraLoadingScreenSubsystem.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::FuncParams = { (UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame, nullptr, "LoadingScreenWidgetChangedDelegate__DelegateSignature", nullptr, nullptr, sizeof(Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::_Script_SkyShooterGame_eventLoadingScreenWidgetChangedDelegate_Parms), Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x00130000, 0, 0, METADATA_PARAMS(Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature_Statics::FuncParams);
		}
...
#endif
	const UECodeGen_Private::FMulticastDelegatePropertyParams Z_Construct_UClass_ULyraLoadingScreenSubsystem_Statics::NewProp_OnLoadingScreenWidgetChanged = { "OnLoadingScreenWidgetChanged", nullptr, (EPropertyFlags)0x0040000010080000, UECodeGen_Private::EPropertyGenFlags::InlineMulticastDelegate, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraLoadingScreenSubsystem, OnLoadingScreenWidgetChanged), Z_Construct_UDelegateFunction_SkyShooterGame_LoadingScreenWidgetChangedDelegate__DelegateSignature, METADATA_PARAMS(Z_Construct_UClass_ULyraLoadingScreenSubsystem_Statics::NewProp_OnLoadingScreenWidgetChanged_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraLoadingScreenSubsystem_Statics::NewProp_OnLoadingScreenWidgetChanged_MetaData)) }; // 2672870816
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraLoadingScreenSubsystem>()
	{
		return ULyraLoadingScreenSubsystem::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraLoadingScreenSubsystem);
	ULyraLoadingScreenSubsystem::~ULyraLoadingScreenSubsystem() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Foundation_LyraLoadingScreenSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Foundation_LyraLoadingScreenSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraLoadingScreenSubsystem, ULyraLoadingScreenSubsystem::StaticClass, TEXT("ULyraLoadingScreenSubsystem"), &Z_Registration_Info_UClass_ULyraLoadingScreenSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraLoadingScreenSubsystem), 3009007423U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Foundation_LyraLoadingScreenSubsystem_h_2884908749(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Foundation_LyraLoadingScreenSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Foundation_LyraLoadingScreenSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
