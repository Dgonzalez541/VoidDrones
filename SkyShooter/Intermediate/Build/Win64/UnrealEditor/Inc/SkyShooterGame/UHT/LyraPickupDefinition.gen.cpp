...
#include "SkyShooterGame/Equipment/LyraPickupDefinition.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPickupDefinition();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPickupDefinition_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraWeaponPickupDefinition();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraWeaponPickupDefinition_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraPickupDefinition>()
	{
		return ULyraPickupDefinition::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraWeaponPickupDefinition>()
	{
		return ULyraWeaponPickupDefinition::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraWeaponPickupDefinition);
	ULyraWeaponPickupDefinition::~ULyraWeaponPickupDefinition() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraPickupDefinition_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraPickupDefinition_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraPickupDefinition, ULyraPickupDefinition::StaticClass, TEXT("ULyraPickupDefinition"), &Z_Registration_Info_UClass_ULyraPickupDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraPickupDefinition), 794416148U) },
		{ Z_Construct_UClass_ULyraWeaponPickupDefinition, ULyraWeaponPickupDefinition::StaticClass, TEXT("ULyraWeaponPickupDefinition"), &Z_Registration_Info_UClass_ULyraWeaponPickupDefinition, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraWeaponPickupDefinition), 2638490536U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraPickupDefinition_h_3946755382(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraPickupDefinition_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraPickupDefinition_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
