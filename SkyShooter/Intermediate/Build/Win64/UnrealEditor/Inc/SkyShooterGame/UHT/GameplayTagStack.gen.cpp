...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FGameplayTagStack();
...
class UScriptStruct* FGameplayTagStack::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayTagStack.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagStack, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("GameplayTagStack"));
	}
	return Z_Registration_Info_UScriptStruct_GameplayTagStack.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FGameplayTagStack>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_Tag = { "Tag", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FGameplayTagStack, Tag), Z_Construct_UScriptStruct_FGameplayTag, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_Tag_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_Tag_MetaData)) }; // 1225434376
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_StackCount = { "StackCount", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FGameplayTagStack, StackCount), METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_StackCount_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewProp_StackCount_MetaData)) };
...
class UScriptStruct* FGameplayTagStackContainer::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_GameplayTagStackContainer.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FGameplayTagStackContainer, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("GameplayTagStackContainer"));
	}
	return Z_Registration_Info_UScriptStruct_GameplayTagStackContainer.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FGameplayTagStackContainer>()
{
...
UE_NET_IMPLEMENT_FASTARRAY(FGameplayTagStackContainer);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks_Inner = { "Stacks", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FGameplayTagStack, METADATA_PARAMS(nullptr, 0) }; // 3063033481
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks = { "Stacks", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FGameplayTagStackContainer, Stacks), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FGameplayTagStackContainer_Statics::NewProp_Stacks_MetaData)) }; // 3063033481
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_GameplayTagStack_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_GameplayTagStack_h_Statics::ScriptStructInfo[] = {
		{ FGameplayTagStack::StaticStruct, Z_Construct_UScriptStruct_FGameplayTagStack_Statics::NewStructOps, TEXT("GameplayTagStack"), &Z_Registration_Info_UScriptStruct_GameplayTagStack, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FGameplayTagStack), 3063033481U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_GameplayTagStack_h_2955574625(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_GameplayTagStack_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_GameplayTagStack_h_Statics::ScriptStructInfo),
		nullptr, 0);
