...
#include "SkyShooterGame/Performance/LyraPerformanceStatSubsystem.h"
#include "Engine/Classes/Engine/GameInstance.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraPerformanceStatSubsystem() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UGameInstanceSubsystem();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPerformanceStatSubsystem();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraPerformanceStatSubsystem_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraPerformanceStatSubsystem_GetCachedStat, "GetCachedStat" }, // 3782376481
	};
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraPerformanceStatSubsystem>()
	{
		return ULyraPerformanceStatSubsystem::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraPerformanceStatSubsystem);
	ULyraPerformanceStatSubsystem::~ULyraPerformanceStatSubsystem() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatSubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatSubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraPerformanceStatSubsystem, ULyraPerformanceStatSubsystem::StaticClass, TEXT("ULyraPerformanceStatSubsystem"), &Z_Registration_Info_UClass_ULyraPerformanceStatSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraPerformanceStatSubsystem), 2167472496U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatSubsystem_h_869086437(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatSubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatSubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
