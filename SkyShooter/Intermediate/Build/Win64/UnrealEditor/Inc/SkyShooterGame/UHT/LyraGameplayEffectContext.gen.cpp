...
#include "SkyShooterGame/AbilitySystem/LyraGameplayEffectContext.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraGameplayEffectContext();
...
class UScriptStruct* FLyraGameplayEffectContext::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraGameplayEffectContext.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraGameplayEffectContext, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraGameplayEffectContext"));
	}
	return Z_Registration_Info_UScriptStruct_LyraGameplayEffectContext.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraGameplayEffectContext>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayEffectContext_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayEffectContext_h_Statics::ScriptStructInfo[] = {
		{ FLyraGameplayEffectContext::StaticStruct, Z_Construct_UScriptStruct_FLyraGameplayEffectContext_Statics::NewStructOps, TEXT("LyraGameplayEffectContext"), &Z_Registration_Info_UScriptStruct_LyraGameplayEffectContext, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraGameplayEffectContext), 905546181U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayEffectContext_h_1003826840(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayEffectContext_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraGameplayEffectContext_h_Statics::ScriptStructInfo),
		nullptr, 0);
