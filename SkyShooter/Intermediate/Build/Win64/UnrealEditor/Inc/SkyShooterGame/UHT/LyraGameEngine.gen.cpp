...
#include "SkyShooterGame/System/LyraGameEngine.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraGameEngine() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UGameEngine();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraGameEngine();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraGameEngine_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraGameEngine>()
	{
		return ULyraGameEngine::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraGameEngine);
	ULyraGameEngine::~ULyraGameEngine() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameEngine_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameEngine_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraGameEngine, ULyraGameEngine::StaticClass, TEXT("ULyraGameEngine"), &Z_Registration_Info_UClass_ULyraGameEngine, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraGameEngine), 2676219959U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameEngine_h_1957501360(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameEngine_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameEngine_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
