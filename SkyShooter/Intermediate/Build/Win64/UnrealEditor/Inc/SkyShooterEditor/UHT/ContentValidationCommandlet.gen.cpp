...
#include "SkyShooterEditor/Commandlets/ContentValidationCommandlet.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeContentValidationCommandlet() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UCommandlet();
	SKYSHOOTEREDITOR_API UClass* Z_Construct_UClass_UContentValidationCommandlet();
	SKYSHOOTEREDITOR_API UClass* Z_Construct_UClass_UContentValidationCommandlet_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTEREDITOR_API UClass* StaticClass<UContentValidationCommandlet>()
	{
		return UContentValidationCommandlet::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UContentValidationCommandlet);
	UContentValidationCommandlet::~UContentValidationCommandlet() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterEditor_Commandlets_ContentValidationCommandlet_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterEditor_Commandlets_ContentValidationCommandlet_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UContentValidationCommandlet, UContentValidationCommandlet::StaticClass, TEXT("UContentValidationCommandlet"), &Z_Registration_Info_UClass_UContentValidationCommandlet, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UContentValidationCommandlet), 2938462195U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterEditor_Commandlets_ContentValidationCommandlet_h_3302784907(TEXT("/Script/SkyShooterEditor"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterEditor_Commandlets_ContentValidationCommandlet_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterEditor_Commandlets_ContentValidationCommandlet_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
