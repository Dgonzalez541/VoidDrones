...
// Cross Module References
	...
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode();
...
// End Cross Module References
	...
	static UEnum* ECharacterCustomizationCollisionMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ECharacterCustomizationCollisionMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ECharacterCustomizationCollisionMode"));
		}
	...
	struct Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::Enum_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ECharacterCustomizationCollisionMode",
		"ECharacterCustomizationCollisionMode",
		Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode()
	{
		if (!Z_Registration_Info_UEnum_ECharacterCustomizationCollisionMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ECharacterCustomizationCollisionMode.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ECharacterCustomizationCollisionMode_Statics::EnumParams);
		}
...
class UScriptStruct* FLyraCharacterPartHandle::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraCharacterPartHandle.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraCharacterPartHandle, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraCharacterPartHandle"));
	}
	return Z_Registration_Info_UScriptStruct_LyraCharacterPartHandle.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraCharacterPartHandle>()
{
...
class UScriptStruct* FLyraCharacterPart::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraCharacterPart.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraCharacterPart, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraCharacterPart"));
	}
	return Z_Registration_Info_UScriptStruct_LyraCharacterPart.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraCharacterPart>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics::EnumInfo[] = {
		{ ECharacterCustomizationCollisionMode_StaticEnum, TEXT("ECharacterCustomizationCollisionMode"), &Z_Registration_Info_UEnum_ECharacterCustomizationCollisionMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1325797198U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics::ScriptStructInfo[] = {
		{ FLyraCharacterPartHandle::StaticStruct, Z_Construct_UScriptStruct_FLyraCharacterPartHandle_Statics::NewStructOps, TEXT("LyraCharacterPartHandle"), &Z_Registration_Info_UScriptStruct_LyraCharacterPartHandle, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraCharacterPartHandle), 2079359947U) },
		{ FLyraCharacterPart::StaticStruct, Z_Construct_UScriptStruct_FLyraCharacterPart_Statics::NewStructOps, TEXT("LyraCharacterPart"), &Z_Registration_Info_UScriptStruct_LyraCharacterPart, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraCharacterPart), 3820300661U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_1906630941(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraCharacterPartTypes_h_Statics::EnumInfo));
