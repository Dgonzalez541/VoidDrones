...
#include "SkyShooterGame/GameFeatures/GameFeatureAction_AddInputContextMapping.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeGameFeatureAction_AddInputContextMapping() {}
// Cross Module References
	ENHANCEDINPUT_API UClass* Z_Construct_UClass_UInputMappingContext_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UGameFeatureAction_WorldActionBase();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FInputMappingContextAndPriority();
...
class UScriptStruct* FInputMappingContextAndPriority::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InputMappingContextAndPriority.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInputMappingContextAndPriority, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("InputMappingContextAndPriority"));
	}
	return Z_Registration_Info_UScriptStruct_InputMappingContextAndPriority.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FInputMappingContextAndPriority>()
{
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping_Statics::NewProp_InputMappings_Inner = { "InputMappings", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FInputMappingContextAndPriority, METADATA_PARAMS(nullptr, 0) }; // 2150697970
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UGameFeatureAction_AddInputContextMapping>()
	{
		return UGameFeatureAction_AddInputContextMapping::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UGameFeatureAction_AddInputContextMapping, UGameFeatureAction_AddInputContextMapping::StaticClass, TEXT("UGameFeatureAction_AddInputContextMapping"), &Z_Registration_Info_UClass_UGameFeatureAction_AddInputContextMapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGameFeatureAction_AddInputContextMapping), 2579366781U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_3390158391(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameFeatures_GameFeatureAction_AddInputContextMapping_h_Statics::ScriptStructInfo),
		nullptr, 0);
