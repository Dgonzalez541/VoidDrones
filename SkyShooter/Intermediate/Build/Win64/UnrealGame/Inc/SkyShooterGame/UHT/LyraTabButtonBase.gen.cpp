...
#include "SkyShooterGame/UI/Common/LyraTabButtonBase.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraButtonBase();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTabButtonBase();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTabButtonBase_NoRegister();
...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraTabButtonBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraTabButtonBase_SetTabLabelInfo_Implementation, "SetTabLabelInfo_Implementation" }, // 3790450735
	};
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ULyraTabButtonBase_Statics::PropPointers[] = {
		...
		const UECodeGen_Private::FImplementedInterfaceParams Z_Construct_UClass_ULyraTabButtonBase_Statics::InterfaceParams[] = {
			{ Z_Construct_UClass_ULyraTabButtonInterface_NoRegister, (int32)VTABLE_OFFSET(ULyraTabButtonBase, ILyraTabButtonInterface), false },  // 1752489500
		};
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraTabButtonBase>()
	{
		return ULyraTabButtonBase::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraTabButtonBase);
	ULyraTabButtonBase::~ULyraTabButtonBase() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabButtonBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabButtonBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraTabButtonBase, ULyraTabButtonBase::StaticClass, TEXT("ULyraTabButtonBase"), &Z_Registration_Info_UClass_ULyraTabButtonBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraTabButtonBase), 3579597900U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabButtonBase_h_3524404174(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabButtonBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabButtonBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
