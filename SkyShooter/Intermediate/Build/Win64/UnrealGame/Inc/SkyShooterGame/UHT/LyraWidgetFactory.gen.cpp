...
#include "SkyShooterGame/UI/Common/LyraWidgetFactory.h"
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraWidgetFactory>()
	{
		return ULyraWidgetFactory::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraWidgetFactory);
	ULyraWidgetFactory::~ULyraWidgetFactory() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraWidgetFactory_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraWidgetFactory_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraWidgetFactory, ULyraWidgetFactory::StaticClass, TEXT("ULyraWidgetFactory"), &Z_Registration_Info_UClass_ULyraWidgetFactory, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraWidgetFactory), 1392273313U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraWidgetFactory_h_1296355104(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraWidgetFactory_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraWidgetFactory_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
