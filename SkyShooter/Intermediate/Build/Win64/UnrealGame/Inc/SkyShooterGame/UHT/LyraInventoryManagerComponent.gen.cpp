...
#include "SkyShooterGame/Inventory/LyraInventoryManagerComponent.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryManagerComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryManagerComponent_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraInventoryChangeMessage();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraInventoryEntry();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraInventoryList();
...
class UScriptStruct* FLyraInventoryChangeMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInventoryChangeMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInventoryChangeMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraInventoryChangeMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraInventoryChangeMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraInventoryChangeMessage>()
{
...
class UScriptStruct* FLyraInventoryEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInventoryEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInventoryEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraInventoryEntry"));
	}
	return Z_Registration_Info_UScriptStruct_LyraInventoryEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraInventoryEntry>()
{
...
class UScriptStruct* FLyraInventoryList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInventoryList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInventoryList, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraInventoryList"));
	}
	return Z_Registration_Info_UScriptStruct_LyraInventoryList.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraInventoryList>()
{
...
UE_NET_IMPLEMENT_FASTARRAY(FLyraInventoryList);
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UScriptStruct_FLyraInventoryList_Statics::NewProp_Entries_Inner = { "Entries", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FLyraInventoryEntry, METADATA_PARAMS(nullptr, 0) }; // 82850588
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraInventoryManagerComponent>()
	{
		return ULyraInventoryManagerComponent::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics::ScriptStructInfo[] = {
		{ FLyraInventoryChangeMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraInventoryChangeMessage_Statics::NewStructOps, TEXT("LyraInventoryChangeMessage"), &Z_Registration_Info_UScriptStruct_LyraInventoryChangeMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraInventoryChangeMessage), 188520811U) },
		{ FLyraInventoryEntry::StaticStruct, Z_Construct_UScriptStruct_FLyraInventoryEntry_Statics::NewStructOps, TEXT("LyraInventoryEntry"), &Z_Registration_Info_UScriptStruct_LyraInventoryEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraInventoryEntry), 82850588U) },
		{ FLyraInventoryList::StaticStruct, Z_Construct_UScriptStruct_FLyraInventoryList_Statics::NewStructOps, TEXT("LyraInventoryList"), &Z_Registration_Info_UScriptStruct_LyraInventoryList, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraInventoryList), 2516088457U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraInventoryManagerComponent, ULyraInventoryManagerComponent::StaticClass, TEXT("ULyraInventoryManagerComponent"), &Z_Registration_Info_UClass_ULyraInventoryManagerComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraInventoryManagerComponent), 3816322786U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_255121600(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_LyraInventoryManagerComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
