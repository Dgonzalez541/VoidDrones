...
#include "SkyShooterGame/AbilitySystem/Executions/LyraDamageExecution.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraDamageExecution() {}
// Cross Module References
	GAMEPLAYABILITIES_API UClass* Z_Construct_UClass_UGameplayEffectExecutionCalculation();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDamageExecution();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDamageExecution_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraDamageExecution>()
	{
		return ULyraDamageExecution::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraDamageExecution);
	ULyraDamageExecution::~ULyraDamageExecution() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraDamageExecution_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraDamageExecution_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraDamageExecution, ULyraDamageExecution::StaticClass, TEXT("ULyraDamageExecution"), &Z_Registration_Info_UClass_ULyraDamageExecution, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraDamageExecution), 1680181327U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraDamageExecution_h_2360668151(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraDamageExecution_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Executions_LyraDamageExecution_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
