...
#include "SkyShooterGame/Interaction/LyraInteractionDurationMessage.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraInteractionDurationMessage() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AActor_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraInteractionDurationMessage();
...
class UScriptStruct* FLyraInteractionDurationMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraInteractionDurationMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraInteractionDurationMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraInteractionDurationMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraInteractionDurationMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraInteractionDurationMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_LyraInteractionDurationMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_LyraInteractionDurationMessage_h_Statics::ScriptStructInfo[] = {
		{ FLyraInteractionDurationMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraInteractionDurationMessage_Statics::NewStructOps, TEXT("LyraInteractionDurationMessage"), &Z_Registration_Info_UScriptStruct_LyraInteractionDurationMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraInteractionDurationMessage), 3887233440U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_LyraInteractionDurationMessage_h_3876304491(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_LyraInteractionDurationMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_LyraInteractionDurationMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
