...
#include "SkyShooterGame/Messages/LyraVerbMessageReplication.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraVerbMessageReplication();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraVerbMessageReplicationEntry();
...
class UScriptStruct* FLyraVerbMessageReplicationEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraVerbMessageReplicationEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraVerbMessageReplicationEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraVerbMessageReplicationEntry"));
	}
	return Z_Registration_Info_UScriptStruct_LyraVerbMessageReplicationEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraVerbMessageReplicationEntry>()
{
...
class UScriptStruct* FLyraVerbMessageReplication::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraVerbMessageReplication.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraVerbMessageReplication, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraVerbMessageReplication"));
	}
	return Z_Registration_Info_UScriptStruct_LyraVerbMessageReplication.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraVerbMessageReplication>()
{
...
UE_NET_IMPLEMENT_FASTARRAY(FLyraVerbMessageReplication);
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UScriptStruct_FLyraVerbMessageReplication_Statics::NewProp_CurrentMessages = { "CurrentMessages", nullptr, (EPropertyFlags)0x0040000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(FLyraVerbMessageReplication, CurrentMessages), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UScriptStruct_FLyraVerbMessageReplication_Statics::NewProp_CurrentMessages_MetaData, UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLyraVerbMessageReplication_Statics::NewProp_CurrentMessages_MetaData)) }; // 2642189250
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessageReplication_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessageReplication_h_Statics::ScriptStructInfo[] = {
		{ FLyraVerbMessageReplicationEntry::StaticStruct, Z_Construct_UScriptStruct_FLyraVerbMessageReplicationEntry_Statics::NewStructOps, TEXT("LyraVerbMessageReplicationEntry"), &Z_Registration_Info_UScriptStruct_LyraVerbMessageReplicationEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraVerbMessageReplicationEntry), 2642189250U) },
		{ FLyraVerbMessageReplication::StaticStruct, Z_Construct_UScriptStruct_FLyraVerbMessageReplication_Statics::NewStructOps, TEXT("LyraVerbMessageReplication"), &Z_Registration_Info_UScriptStruct_LyraVerbMessageReplication, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraVerbMessageReplication), 1784813930U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessageReplication_h_2010730026(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessageReplication_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessageReplication_h_Statics::ScriptStructInfo),
		nullptr, 0);
