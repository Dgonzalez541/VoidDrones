...
#include "SkyShooterGame/Interaction/Tasks/AbilityTask_GrantNearbyInteraction.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeAbilityTask_GrantNearbyInteraction() {}
// Cross Module References
	GAMEPLAYABILITIES_API UClass* Z_Construct_UClass_UAbilityTask();
	GAMEPLAYABILITIES_API UClass* Z_Construct_UClass_UGameplayAbility_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UAbilityTask_GrantNearbyInteraction();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UAbilityTask_GrantNearbyInteraction_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UAbilityTask_GrantNearbyInteraction>()
	{
		return UAbilityTask_GrantNearbyInteraction::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_Tasks_AbilityTask_GrantNearbyInteraction_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_Tasks_AbilityTask_GrantNearbyInteraction_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UAbilityTask_GrantNearbyInteraction, UAbilityTask_GrantNearbyInteraction::StaticClass, TEXT("UAbilityTask_GrantNearbyInteraction"), &Z_Registration_Info_UClass_UAbilityTask_GrantNearbyInteraction, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAbilityTask_GrantNearbyInteraction), 3023398527U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_Tasks_AbilityTask_GrantNearbyInteraction_h_2322661012(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_Tasks_AbilityTask_GrantNearbyInteraction_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_Tasks_AbilityTask_GrantNearbyInteraction_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
