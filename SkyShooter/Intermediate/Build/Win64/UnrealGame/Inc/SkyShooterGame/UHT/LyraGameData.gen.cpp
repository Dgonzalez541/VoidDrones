...
#include "SkyShooterGame/System/LyraGameData.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraGameData() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UPrimaryDataAsset();
	GAMEPLAYABILITIES_API UClass* Z_Construct_UClass_UGameplayEffect_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraGameData();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraGameData>()
	{
		return ULyraGameData::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraGameData);
	ULyraGameData::~ULyraGameData() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraGameData, ULyraGameData::StaticClass, TEXT("ULyraGameData"), &Z_Registration_Info_UClass_ULyraGameData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraGameData), 3741257854U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameData_h_845800263(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_System_LyraGameData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
