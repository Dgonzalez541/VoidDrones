...
#include "SkyShooterGame/UI/LyraActivatableWidget.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraActivatableWidget();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraActivatableWidget_NoRegister();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode();
...
// End Cross Module References
	...
	static UEnum* ELyraWidgetInputMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraWidgetInputMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraWidgetInputMode"));
		}
		return Z_Registration_Info_UEnum_ELyraWidgetInputMode.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<ELyraWidgetInputMode>()
	{
		return ELyraWidgetInputMode_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraWidgetInputMode",
		"ELyraWidgetInputMode",
		Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode()
	{
		if (!Z_Registration_Info_UEnum_ELyraWidgetInputMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraWidgetInputMode.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode_Statics::EnumParams);
		}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraActivatableWidget_Statics::NewProp_InputConfig = { "InputConfig", nullptr, (EPropertyFlags)0x0020080000010001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraActivatableWidget, InputConfig), Z_Construct_UEnum_SkyShooterGame_ELyraWidgetInputMode, METADATA_PARAMS(Z_Construct_UClass_ULyraActivatableWidget_Statics::NewProp_InputConfig_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraActivatableWidget_Statics::NewProp_InputConfig_MetaData)) }; // 2112066273
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraActivatableWidget>()
	{
		return ULyraActivatableWidget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraActivatableWidget);
	ULyraActivatableWidget::~ULyraActivatableWidget() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics::EnumInfo[] = {
		{ ELyraWidgetInputMode_StaticEnum, TEXT("ELyraWidgetInputMode"), &Z_Registration_Info_UEnum_ELyraWidgetInputMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2112066273U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraActivatableWidget, ULyraActivatableWidget::StaticClass, TEXT("ULyraActivatableWidget"), &Z_Registration_Info_UClass_ULyraActivatableWidget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraActivatableWidget), 2741707714U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_3387559514(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_LyraActivatableWidget_h_Statics::EnumInfo));
