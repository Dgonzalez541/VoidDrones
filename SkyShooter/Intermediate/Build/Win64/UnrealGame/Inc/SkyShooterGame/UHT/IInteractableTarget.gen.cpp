...
#include "SkyShooterGame/Interaction/IInteractableTarget.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIInteractableTarget() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInteractableTarget();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UInteractableTarget>()
	{
		return UInteractableTarget::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UInteractableTarget);
	UInteractableTarget::~UInteractableTarget() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractableTarget_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractableTarget_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInteractableTarget, UInteractableTarget::StaticClass, TEXT("UInteractableTarget"), &Z_Registration_Info_UClass_UInteractableTarget, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInteractableTarget), 1196554399U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractableTarget_h_2319944578(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractableTarget_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractableTarget_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
