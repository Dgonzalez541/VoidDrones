...
class UScriptStruct* FLyraVerbMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraVerbMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraVerbMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraVerbMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraVerbMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraVerbMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessage_h_Statics::ScriptStructInfo[] = {
		{ FLyraVerbMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraVerbMessage_Statics::NewStructOps, TEXT("LyraVerbMessage"), &Z_Registration_Info_UScriptStruct_LyraVerbMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraVerbMessage), 3291385382U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessage_h_3401428962(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraVerbMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
