...
#include "SkyShooterGame/Camera/LyraCameraAssistInterface.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraCameraAssistInterface() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraCameraAssistInterface();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraCameraAssistInterface>()
	{
		return ULyraCameraAssistInterface::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraCameraAssistInterface);
	ULyraCameraAssistInterface::~ULyraCameraAssistInterface() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraAssistInterface_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraAssistInterface_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraCameraAssistInterface, ULyraCameraAssistInterface::StaticClass, TEXT("ULyraCameraAssistInterface"), &Z_Registration_Info_UClass_ULyraCameraAssistInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraCameraAssistInterface), 3737729287U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraAssistInterface_h_2064600100(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraAssistInterface_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Camera_LyraCameraAssistInterface_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
