...
#include "SkyShooterGame/Inventory/IPickupable.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemDefinition_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemInstance_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryManagerComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UPickupable();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UPickupable_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UPickupableStatics();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UPickupableStatics_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FInventoryPickup();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FPickupInstance();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FPickupTemplate();
...
class UScriptStruct* FPickupTemplate::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PickupTemplate.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPickupTemplate, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("PickupTemplate"));
	}
	return Z_Registration_Info_UScriptStruct_PickupTemplate.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FPickupTemplate>()
{
...
class UScriptStruct* FPickupInstance::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PickupInstance.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPickupInstance, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("PickupInstance"));
	}
	return Z_Registration_Info_UScriptStruct_PickupInstance.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FPickupInstance>()
{
...
class UScriptStruct* FInventoryPickup::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InventoryPickup.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInventoryPickup, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("InventoryPickup"));
	}
	return Z_Registration_Info_UScriptStruct_InventoryPickup.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FInventoryPickup>()
{
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UPickupable_GetPickupInventory_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(Pickupable_eventGetPickupInventory_Parms, ReturnValue), Z_Construct_UScriptStruct_FInventoryPickup, METADATA_PARAMS(nullptr, 0) }; // 3144046641
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPickupable_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPickupable_GetPickupInventory, "GetPickupInventory" }, // 576453622
	};
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UPickupable>()
	{
		return UPickupable::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UPickupableStatics>()
	{
		return UPickupableStatics::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UPickupableStatics);
	UPickupableStatics::~UPickupableStatics() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics::ScriptStructInfo[] = {
		{ FPickupTemplate::StaticStruct, Z_Construct_UScriptStruct_FPickupTemplate_Statics::NewStructOps, TEXT("PickupTemplate"), &Z_Registration_Info_UScriptStruct_PickupTemplate, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPickupTemplate), 2056845193U) },
		{ FPickupInstance::StaticStruct, Z_Construct_UScriptStruct_FPickupInstance_Statics::NewStructOps, TEXT("PickupInstance"), &Z_Registration_Info_UScriptStruct_PickupInstance, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPickupInstance), 470620089U) },
		{ FInventoryPickup::StaticStruct, Z_Construct_UScriptStruct_FInventoryPickup_Statics::NewStructOps, TEXT("InventoryPickup"), &Z_Registration_Info_UScriptStruct_InventoryPickup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInventoryPickup), 3144046641U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPickupable, UPickupable::StaticClass, TEXT("UPickupable"), &Z_Registration_Info_UClass_UPickupable, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPickupable), 1933251300U) },
		{ Z_Construct_UClass_UPickupableStatics, UPickupableStatics::StaticClass, TEXT("UPickupableStatics"), &Z_Registration_Info_UClass_UPickupableStatics, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPickupableStatics), 1791643948U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_2735383378(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Inventory_IPickupable_h_Statics::ScriptStructInfo),
		nullptr, 0);
