...
#include "SkyShooterGame/UI/PerformanceStats/LyraPerfStatContainerBase.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraPerfStatContainerBase() {}
// Cross Module References
	COMMONUI_API UClass* Z_Construct_UClass_UCommonUserWidget();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPerfStatContainerBase();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPerfStatContainerBase_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraPerfStatContainerBase>()
	{
		return ULyraPerfStatContainerBase::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraPerfStatContainerBase);
	ULyraPerfStatContainerBase::~ULyraPerfStatContainerBase() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_PerformanceStats_LyraPerfStatContainerBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_PerformanceStats_LyraPerfStatContainerBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraPerfStatContainerBase, ULyraPerfStatContainerBase::StaticClass, TEXT("ULyraPerfStatContainerBase"), &Z_Registration_Info_UClass_ULyraPerfStatContainerBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraPerfStatContainerBase), 1475351039U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_PerformanceStats_LyraPerfStatContainerBase_h_3700367203(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_PerformanceStats_LyraPerfStatContainerBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_PerformanceStats_LyraPerfStatContainerBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
