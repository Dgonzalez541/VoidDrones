...
#include "SkyShooterGame/Replays/LyraReplaySubsystem.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReplayList();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReplayList_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReplayListEntry();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReplayListEntry_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReplaySubsystem();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReplaySubsystem_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraReplayListEntry>()
	{
		return ULyraReplayListEntry::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraReplayList>()
	{
		return ULyraReplayList::StaticClass();
	}
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraReplaySubsystem>()
	{
		return ULyraReplaySubsystem::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraReplaySubsystem);
	ULyraReplaySubsystem::~ULyraReplaySubsystem() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Replays_LyraReplaySubsystem_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Replays_LyraReplaySubsystem_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraReplayListEntry, ULyraReplayListEntry::StaticClass, TEXT("ULyraReplayListEntry"), &Z_Registration_Info_UClass_ULyraReplayListEntry, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraReplayListEntry), 3032519681U) },
		{ Z_Construct_UClass_ULyraReplayList, ULyraReplayList::StaticClass, TEXT("ULyraReplayList"), &Z_Registration_Info_UClass_ULyraReplayList, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraReplayList), 4048976596U) },
		{ Z_Construct_UClass_ULyraReplaySubsystem, ULyraReplaySubsystem::StaticClass, TEXT("ULyraReplaySubsystem"), &Z_Registration_Info_UClass_ULyraReplaySubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraReplaySubsystem), 882311949U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Replays_LyraReplaySubsystem_h_3859014190(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Replays_LyraReplaySubsystem_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Replays_LyraReplaySubsystem_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
