...
#include "SkyShooterGame/Input/LyraAimSensitivityData.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraAimSensitivityData() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UPrimaryDataAsset();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAimSensitivityData();
...
// End Cross Module References
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraAimSensitivityData_Statics::NewProp_SensitivityMap_Key_KeyProp = { "SensitivityMap_Key", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UEnum_SkyShooterGame_ELyraGamepadSensitivity, METADATA_PARAMS(nullptr, 0) }; // 4008803939
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraAimSensitivityData>()
	{
		return ULyraAimSensitivityData::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraAimSensitivityData);
	ULyraAimSensitivityData::~ULyraAimSensitivityData() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraAimSensitivityData_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraAimSensitivityData_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraAimSensitivityData, ULyraAimSensitivityData::StaticClass, TEXT("ULyraAimSensitivityData"), &Z_Registration_Info_UClass_ULyraAimSensitivityData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraAimSensitivityData), 1542290107U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraAimSensitivityData_h_3316780782(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraAimSensitivityData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Input_LyraAimSensitivityData_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
