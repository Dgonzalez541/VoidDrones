...
#include "SkyShooterGame/UI/IndicatorSystem/IndicatorLayer.h"
#include "SlateCore/Public/Styling/SlateBrush.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIndicatorLayer() {}
// Cross Module References
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UIndicatorLayer();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UIndicatorLayer_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UIndicatorLayer>()
	{
		return UIndicatorLayer::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UIndicatorLayer);
	UIndicatorLayer::~UIndicatorLayer() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLayer_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLayer_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UIndicatorLayer, UIndicatorLayer::StaticClass, TEXT("UIndicatorLayer"), &Z_Registration_Info_UClass_UIndicatorLayer, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UIndicatorLayer), 472239964U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLayer_h_4226281007(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLayer_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_IndicatorSystem_IndicatorLayer_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
