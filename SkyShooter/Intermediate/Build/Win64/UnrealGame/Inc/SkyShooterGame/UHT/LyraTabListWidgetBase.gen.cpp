...
#include "SkyShooterGame/UI/Common/LyraTabListWidgetBase.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTabButtonInterface();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTabButtonInterface_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTabListWidgetBase();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraTabListWidgetBase_NoRegister();
	SKYSHOOTERGAME_API UFunction* Z_Construct_UDelegateFunction_ULyraTabListWidgetBase_OnTabContentCreated__DelegateSignature();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraTabDescriptor();
...
class UScriptStruct* FLyraTabDescriptor::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraTabDescriptor.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraTabDescriptor, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraTabDescriptor"));
	}
	return Z_Registration_Info_UScriptStruct_LyraTabDescriptor.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraTabDescriptor>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraTabButtonInterface_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraTabButtonInterface_SetTabLabelInfo, "SetTabLabelInfo" }, // 3987517752
	};
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraTabButtonInterface>()
	{
		return ULyraTabButtonInterface::StaticClass();
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraTabListWidgetBase_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraTabListWidgetBase_GetPreregisteredTabInfo, "GetPreregisteredTabInfo" }, // 4043386230
		...
		{ &Z_Construct_UFunction_ULyraTabListWidgetBase_RegisterDynamicTab, "RegisterDynamicTab" }, // 3708442200
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_ULyraTabListWidgetBase_Statics::NewProp_PreregisteredTabInfoArray = { "PreregisteredTabInfoArray", nullptr, (EPropertyFlags)0x0040008000000001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraTabListWidgetBase, PreregisteredTabInfoArray), EArrayPropertyFlags::None, METADATA_PARAMS(Z_Construct_UClass_ULyraTabListWidgetBase_Statics::NewProp_PreregisteredTabInfoArray_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraTabListWidgetBase_Statics::NewProp_PreregisteredTabInfoArray_MetaData)) }; // 4125889879
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULyraTabListWidgetBase_Statics::NewProp_PendingTabLabelInfoMap_ValueProp = { "PendingTabLabelInfoMap", nullptr, (EPropertyFlags)0x0000008000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 1, Z_Construct_UScriptStruct_FLyraTabDescriptor, METADATA_PARAMS(nullptr, 0) }; // 4125889879
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraTabListWidgetBase>()
	{
		return ULyraTabListWidgetBase::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraTabListWidgetBase);
	ULyraTabListWidgetBase::~ULyraTabListWidgetBase() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics::ScriptStructInfo[] = {
		{ FLyraTabDescriptor::StaticStruct, Z_Construct_UScriptStruct_FLyraTabDescriptor_Statics::NewStructOps, TEXT("LyraTabDescriptor"), &Z_Registration_Info_UScriptStruct_LyraTabDescriptor, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraTabDescriptor), 4125889879U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraTabButtonInterface, ULyraTabButtonInterface::StaticClass, TEXT("ULyraTabButtonInterface"), &Z_Registration_Info_UClass_ULyraTabButtonInterface, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraTabButtonInterface), 1752489500U) },
		{ Z_Construct_UClass_ULyraTabListWidgetBase, ULyraTabListWidgetBase::StaticClass, TEXT("ULyraTabListWidgetBase"), &Z_Registration_Info_UClass_ULyraTabListWidgetBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraTabListWidgetBase), 377418892U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_1506646322(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Common_LyraTabListWidgetBase_h_Statics::ScriptStructInfo),
		nullptr, 0);
