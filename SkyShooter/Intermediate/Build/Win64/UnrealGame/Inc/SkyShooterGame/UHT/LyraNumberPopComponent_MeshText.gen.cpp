...
#include "SkyShooterGame/Feedback/NumberPops/LyraNumberPopComponent_MeshText.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraNumberPopComponent_MeshText() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_UStaticMesh_NoRegister();
	ENGINE_API UClass* Z_Construct_UClass_UStaticMeshComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDamagePopStyle_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent_MeshText();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent_MeshText_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLiveNumberPopEntry();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FPooledNumberPopComponentList();
...
class UScriptStruct* FPooledNumberPopComponentList::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_PooledNumberPopComponentList.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FPooledNumberPopComponentList, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("PooledNumberPopComponentList"));
	}
	return Z_Registration_Info_UScriptStruct_PooledNumberPopComponentList.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FPooledNumberPopComponentList>()
{
...
class UScriptStruct* FLiveNumberPopEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LiveNumberPopEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLiveNumberPopEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LiveNumberPopEntry"));
	}
	return Z_Registration_Info_UScriptStruct_LiveNumberPopEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLiveNumberPopEntry>()
{
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraNumberPopComponent_MeshText>()
	{
		return ULyraNumberPopComponent_MeshText::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ScriptStructInfo[] = {
		{ FPooledNumberPopComponentList::StaticStruct, Z_Construct_UScriptStruct_FPooledNumberPopComponentList_Statics::NewStructOps, TEXT("PooledNumberPopComponentList"), &Z_Registration_Info_UScriptStruct_PooledNumberPopComponentList, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPooledNumberPopComponentList), 3516286965U) },
		{ FLiveNumberPopEntry::StaticStruct, Z_Construct_UScriptStruct_FLiveNumberPopEntry_Statics::NewStructOps, TEXT("LiveNumberPopEntry"), &Z_Registration_Info_UScriptStruct_LiveNumberPopEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLiveNumberPopEntry), 2980725836U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraNumberPopComponent_MeshText, ULyraNumberPopComponent_MeshText::StaticClass, TEXT("ULyraNumberPopComponent_MeshText"), &Z_Registration_Info_UClass_ULyraNumberPopComponent_MeshText, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraNumberPopComponent_MeshText), 1509017810U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_2640566169(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_MeshText_h_Statics::ScriptStructInfo),
		nullptr, 0);
