...
#include "SkyShooterGame/Interaction/IInteractionInstigator.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeIInteractionInstigator() {}
// Cross Module References
	COREUOBJECT_API UClass* Z_Construct_UClass_UInterface();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInteractionInstigator();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_UInteractionInstigator_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<UInteractionInstigator>()
	{
		return UInteractionInstigator::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UInteractionInstigator);
	UInteractionInstigator::~UInteractionInstigator() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractionInstigator_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractionInstigator_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UInteractionInstigator, UInteractionInstigator::StaticClass, TEXT("UInteractionInstigator"), &Z_Registration_Info_UClass_UInteractionInstigator, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UInteractionInstigator), 1713076103U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractionInstigator_h_672529738(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractionInstigator_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_IInteractionInstigator_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
