...
#include "SkyShooterGame/Feedback/NumberPops/LyraNumberPopComponent.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraNumberPopRequest();
...
class UScriptStruct* FLyraNumberPopRequest::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraNumberPopRequest.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraNumberPopRequest, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraNumberPopRequest"));
	}
	return Z_Registration_Info_UScriptStruct_LyraNumberPopRequest.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraNumberPopRequest>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraNumberPopComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraNumberPopComponent_AddNumberPop, "AddNumberPop" }, // 1360048546
	};
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraNumberPopComponent>()
	{
		return ULyraNumberPopComponent::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraNumberPopComponent);
	ULyraNumberPopComponent::~ULyraNumberPopComponent() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics::ScriptStructInfo[] = {
		{ FLyraNumberPopRequest::StaticStruct, Z_Construct_UScriptStruct_FLyraNumberPopRequest_Statics::NewStructOps, TEXT("LyraNumberPopRequest"), &Z_Registration_Info_UScriptStruct_LyraNumberPopRequest, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraNumberPopRequest), 3845206314U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraNumberPopComponent, ULyraNumberPopComponent::StaticClass, TEXT("ULyraNumberPopComponent"), &Z_Registration_Info_UClass_ULyraNumberPopComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraNumberPopComponent), 1285912524U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_1606988084(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
