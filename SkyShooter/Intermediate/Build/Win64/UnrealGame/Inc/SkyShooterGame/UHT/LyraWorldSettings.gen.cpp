...
#include "SkyShooterGame/GameModes/LyraWorldSettings.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraWorldSettings() {}
// Cross Module References
	ENGINE_API UClass* Z_Construct_UClass_AWorldSettings();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraWorldSettings();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ALyraWorldSettings_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ALyraWorldSettings>()
	{
		return ALyraWorldSettings::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ALyraWorldSettings);
	ALyraWorldSettings::~ALyraWorldSettings() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraWorldSettings_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraWorldSettings_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ALyraWorldSettings, ALyraWorldSettings::StaticClass, TEXT("ALyraWorldSettings"), &Z_Registration_Info_UClass_ALyraWorldSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ALyraWorldSettings), 580301266U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraWorldSettings_h_130848934(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraWorldSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_GameModes_LyraWorldSettings_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
