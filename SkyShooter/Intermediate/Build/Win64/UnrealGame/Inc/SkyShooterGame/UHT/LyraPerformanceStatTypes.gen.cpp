...
#include "SkyShooterGame/Performance/LyraPerformanceStatTypes.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode();
...
// End Cross Module References
	...
	static UEnum* ELyraStatDisplayMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraStatDisplayMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraStatDisplayMode"));
		}
		return Z_Registration_Info_UEnum_ELyraStatDisplayMode.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<ELyraStatDisplayMode>()
	{
		return ELyraStatDisplayMode_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraStatDisplayMode",
		"ELyraStatDisplayMode",
		Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode()
	{
		if (!Z_Registration_Info_UEnum_ELyraStatDisplayMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraStatDisplayMode.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraStatDisplayMode_Statics::EnumParams);
		}
	...
	static UEnum* ELyraDisplayablePerformanceStat_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraDisplayablePerformanceStat"));
		}
		return Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<ELyraDisplayablePerformanceStat>()
	{
		return ELyraDisplayablePerformanceStat_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics
	{
		static const UECodeGen_Private::FEnumeratorParam Enumerators[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Enum_MetaDataParams[];
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::Enum_MetaDataParams[] = {
		{ "BlueprintType", "true" },
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraDisplayablePerformanceStat",
		"ELyraDisplayablePerformanceStat",
		Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat()
	{
		if (!Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat_Statics::EnumParams);
		}
		return Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat.InnerSingleton;
	}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatTypes_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatTypes_h_Statics::EnumInfo[] = {
		{ ELyraStatDisplayMode_StaticEnum, TEXT("ELyraStatDisplayMode"), &Z_Registration_Info_UEnum_ELyraStatDisplayMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 1946464423U) },
		{ ELyraDisplayablePerformanceStat_StaticEnum, TEXT("ELyraDisplayablePerformanceStat"), &Z_Registration_Info_UEnum_ELyraDisplayablePerformanceStat, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2043812584U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatTypes_h_1539748707(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatTypes_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceStatTypes_h_Statics::EnumInfo));
