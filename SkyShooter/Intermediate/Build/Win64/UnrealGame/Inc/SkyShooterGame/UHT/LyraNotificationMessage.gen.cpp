...
#include "SkyShooterGame/Messages/LyraNotificationMessage.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraNotificationMessage();
...
class UScriptStruct* FLyraNotificationMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraNotificationMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraNotificationMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraNotificationMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraNotificationMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraNotificationMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraNotificationMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraNotificationMessage_h_Statics::ScriptStructInfo[] = {
		{ FLyraNotificationMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraNotificationMessage_Statics::NewStructOps, TEXT("LyraNotificationMessage"), &Z_Registration_Info_UScriptStruct_LyraNotificationMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraNotificationMessage), 3010819143U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraNotificationMessage_h_1954063526(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraNotificationMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Messages_LyraNotificationMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
