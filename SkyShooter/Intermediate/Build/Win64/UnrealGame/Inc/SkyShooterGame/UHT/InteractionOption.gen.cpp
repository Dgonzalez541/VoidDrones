...
class UScriptStruct* FInteractionOption::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_InteractionOption.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FInteractionOption, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("InteractionOption"));
	}
	return Z_Registration_Info_UScriptStruct_InteractionOption.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FInteractionOption>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionOption_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionOption_h_Statics::ScriptStructInfo[] = {
		{ FInteractionOption::StaticStruct, Z_Construct_UScriptStruct_FInteractionOption_Statics::NewStructOps, TEXT("InteractionOption"), &Z_Registration_Info_UScriptStruct_InteractionOption, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FInteractionOption), 3385769534U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionOption_h_3404420648(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionOption_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Interaction_InteractionOption_h_Statics::ScriptStructInfo),
		nullptr, 0);
