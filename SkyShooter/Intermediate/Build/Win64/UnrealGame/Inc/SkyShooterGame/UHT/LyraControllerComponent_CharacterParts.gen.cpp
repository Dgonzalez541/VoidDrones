...
#include "SkyShooterGame/Cosmetics/LyraControllerComponent_CharacterParts.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraControllerComponent_CharacterParts();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraControllerComponent_CharacterParts_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraCharacterPart();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraControllerCharacterPartEntry();
...
class UScriptStruct* FLyraControllerCharacterPartEntry::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraControllerCharacterPartEntry.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraControllerCharacterPartEntry, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraControllerCharacterPartEntry"));
	}
	return Z_Registration_Info_UScriptStruct_LyraControllerCharacterPartEntry.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraControllerCharacterPartEntry>()
{
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraControllerComponent_CharacterParts_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ULyraControllerComponent_CharacterParts_AddCharacterPart, "AddCharacterPart" }, // 1349497006
		...
		{ &Z_Construct_UFunction_ULyraControllerComponent_CharacterParts_RemoveCharacterPart, "RemoveCharacterPart" }, // 1596391400
	};
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraControllerComponent_CharacterParts>()
	{
		return ULyraControllerComponent_CharacterParts::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics::ScriptStructInfo[] = {
		{ FLyraControllerCharacterPartEntry::StaticStruct, Z_Construct_UScriptStruct_FLyraControllerCharacterPartEntry_Statics::NewStructOps, TEXT("LyraControllerCharacterPartEntry"), &Z_Registration_Info_UScriptStruct_LyraControllerCharacterPartEntry, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraControllerCharacterPartEntry), 321602046U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_484878669(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Cosmetics_LyraControllerComponent_CharacterParts_h_Statics::ScriptStructInfo),
		nullptr, 0);
