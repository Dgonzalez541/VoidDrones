...
#include "SkyShooterGame/AbilitySystem/Abilities/LyraAbilitySimpleFailureMessage.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraAbilitySimpleFailureMessage();
...
class UScriptStruct* FLyraAbilitySimpleFailureMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilitySimpleFailureMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilitySimpleFailureMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraAbilitySimpleFailureMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraAbilitySimpleFailureMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraAbilitySimpleFailureMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics::ScriptStructInfo[] = {
		{ FLyraAbilitySimpleFailureMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraAbilitySimpleFailureMessage_Statics::NewStructOps, TEXT("LyraAbilitySimpleFailureMessage"), &Z_Registration_Info_UScriptStruct_LyraAbilitySimpleFailureMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraAbilitySimpleFailureMessage), 1858500981U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_1435103805(TEXT("/Script/SkyShooterGame"),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Abilities_LyraAbilitySimpleFailureMessage_h_Statics::ScriptStructInfo),
		nullptr, 0);
