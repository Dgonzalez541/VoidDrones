...
#include "SkyShooterGame/Performance/LyraPerformanceSettings.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPerformanceSettings();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPerformanceSettings_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPlatformSpecificRenderingSettings();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraPlatformSpecificRenderingSettings_NoRegister();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat();
	SKYSHOOTERGAME_API UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraPerformanceStatGroup();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraQualityDeviceProfileVariant();
...
class UScriptStruct* FLyraQualityDeviceProfileVariant::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraQualityDeviceProfileVariant.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraQualityDeviceProfileVariant, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraQualityDeviceProfileVariant"));
	}
	return Z_Registration_Info_UScriptStruct_LyraQualityDeviceProfileVariant.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraQualityDeviceProfileVariant>()
{
...
class UScriptStruct* FLyraPerformanceStatGroup::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraPerformanceStatGroup.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraPerformanceStatGroup, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraPerformanceStatGroup"));
	}
	return Z_Registration_Info_UScriptStruct_LyraPerformanceStatGroup.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraPerformanceStatGroup>()
{
	...
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UScriptStruct_FLyraPerformanceStatGroup_Statics::NewProp_AllowedStats_ElementProp = { "AllowedStats", nullptr, (EPropertyFlags)0x0000000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UEnum_SkyShooterGame_ELyraDisplayablePerformanceStat, METADATA_PARAMS(nullptr, 0) }; // 2043812584
#if WITH_METADATA
	...
	static UEnum* ELyraFramePacingMode_StaticEnum()
	{
		...
		{
			Z_Registration_Info_UEnum_ELyraFramePacingMode.OuterSingleton = GetStaticEnum(Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("ELyraFramePacingMode"));
		}
		return Z_Registration_Info_UEnum_ELyraFramePacingMode.OuterSingleton;
	}
	template<> SKYSHOOTERGAME_API UEnum* StaticEnum<ELyraFramePacingMode>()
	{
		return ELyraFramePacingMode_StaticEnum();
	}
	struct Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics
	{
	...
	const UECodeGen_Private::FEnumeratorParam Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::Enumerators[] = {
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::Enum_MetaDataParams[] = {
...
#endif
	const UECodeGen_Private::FEnumParams Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::EnumParams = {
		(UObject*(*)())Z_Construct_UPackage__Script_SkyShooterGame,
		nullptr,
		"ELyraFramePacingMode",
		"ELyraFramePacingMode",
		Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::Enumerators,
		UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::Enumerators),
		RF_Public|RF_Transient|RF_MarkAsNative,
		EEnumFlags::None,
		(uint8)UEnum::ECppForm::EnumClass,
		METADATA_PARAMS(Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::Enum_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::Enum_MetaDataParams))
	};
	UEnum* Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode()
	{
		if (!Z_Registration_Info_UEnum_ELyraFramePacingMode.InnerSingleton)
		{
			UECodeGen_Private::ConstructUEnum(Z_Registration_Info_UEnum_ELyraFramePacingMode.InnerSingleton, Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode_Statics::EnumParams);
		}
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_ULyraPlatformSpecificRenderingSettings_Statics::NewProp_FramePacingMode = { "FramePacingMode", nullptr, (EPropertyFlags)0x0010000000004001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ULyraPlatformSpecificRenderingSettings, FramePacingMode), Z_Construct_UEnum_SkyShooterGame_ELyraFramePacingMode, METADATA_PARAMS(Z_Construct_UClass_ULyraPlatformSpecificRenderingSettings_Statics::NewProp_FramePacingMode_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_ULyraPlatformSpecificRenderingSettings_Statics::NewProp_FramePacingMode_MetaData)) }; // 595451571
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraPlatformSpecificRenderingSettings>()
	{
		return ULyraPlatformSpecificRenderingSettings::StaticClass();
	}
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_ULyraPerformanceSettings_Statics::NewProp_UserFacingPerformanceStats_Inner = { "UserFacingPerformanceStats", nullptr, (EPropertyFlags)0x0000000000004000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, 0, Z_Construct_UScriptStruct_FLyraPerformanceStatGroup, METADATA_PARAMS(nullptr, 0) }; // 2078098207
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraPerformanceSettings>()
	{
		return ULyraPerformanceSettings::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraPerformanceSettings);
	ULyraPerformanceSettings::~ULyraPerformanceSettings() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::EnumInfo[] = {
		{ ELyraFramePacingMode_StaticEnum, TEXT("ELyraFramePacingMode"), &Z_Registration_Info_UEnum_ELyraFramePacingMode, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 595451571U) },
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::ScriptStructInfo[] = {
		{ FLyraQualityDeviceProfileVariant::StaticStruct, Z_Construct_UScriptStruct_FLyraQualityDeviceProfileVariant_Statics::NewStructOps, TEXT("LyraQualityDeviceProfileVariant"), &Z_Registration_Info_UScriptStruct_LyraQualityDeviceProfileVariant, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraQualityDeviceProfileVariant), 912916295U) },
		{ FLyraPerformanceStatGroup::StaticStruct, Z_Construct_UScriptStruct_FLyraPerformanceStatGroup_Statics::NewStructOps, TEXT("LyraPerformanceStatGroup"), &Z_Registration_Info_UScriptStruct_LyraPerformanceStatGroup, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraPerformanceStatGroup), 2078098207U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::ClassInfo[] = {
		...
		{ Z_Construct_UClass_ULyraPerformanceSettings, ULyraPerformanceSettings::StaticClass, TEXT("ULyraPerformanceSettings"), &Z_Registration_Info_UClass_ULyraPerformanceSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraPerformanceSettings), 2224152306U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_2110473759(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::ScriptStructInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Performance_LyraPerformanceSettings_h_Statics::EnumInfo));
