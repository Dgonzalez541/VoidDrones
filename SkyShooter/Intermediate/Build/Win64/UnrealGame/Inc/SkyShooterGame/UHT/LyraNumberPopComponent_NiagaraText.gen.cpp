...
#include "SkyShooterGame/Feedback/NumberPops/LyraNumberPopComponent_NiagaraText.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraNumberPopComponent_NiagaraText() {}
// Cross Module References
	NIAGARA_API UClass* Z_Construct_UClass_UNiagaraComponent_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraDamagePopStyleNiagara_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent_NiagaraText();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraNumberPopComponent_NiagaraText_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraNumberPopComponent_NiagaraText>()
	{
		return ULyraNumberPopComponent_NiagaraText::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_NiagaraText_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_NiagaraText_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraNumberPopComponent_NiagaraText, ULyraNumberPopComponent_NiagaraText::StaticClass, TEXT("ULyraNumberPopComponent_NiagaraText"), &Z_Registration_Info_UClass_ULyraNumberPopComponent_NiagaraText, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraNumberPopComponent_NiagaraText), 3755300511U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_NiagaraText_h_785195517(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_NiagaraText_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Feedback_NumberPops_LyraNumberPopComponent_NiagaraText_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
