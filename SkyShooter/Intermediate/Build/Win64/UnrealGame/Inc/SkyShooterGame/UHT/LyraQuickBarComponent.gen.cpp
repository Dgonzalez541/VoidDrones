...
#include "SkyShooterGame/Equipment/LyraQuickBarComponent.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraEquipmentInstance_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraInventoryItemInstance_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraQuickBarComponent();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraQuickBarComponent_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraQuickBarActiveIndexChangedMessage();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraQuickBarSlotsChangedMessage();
...
// End Cross Module References
	...
	DEFINE_FUNCTION(ULyraQuickBarComponent::execToggleWeapons)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->ToggleWeapons();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(ULyraQuickBarComponent::execUnequipWeapons)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UnequipWeapons();
		P_NATIVE_END;
	}
	...
	void ULyraQuickBarComponent::StaticRegisterNativesULyraQuickBarComponent()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			...
			{ "ToggleWeapons", &ULyraQuickBarComponent::execToggleWeapons },
			{ "UnequipWeapons", &ULyraQuickBarComponent::execUnequipWeapons },
		};
	...
	struct Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons_Statics::Function_MetaDataParams[] = {
		{ "Category", "Lyra" },
		{ "ModuleRelativePath", "Equipment/LyraQuickBarComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULyraQuickBarComponent, nullptr, "ToggleWeapons", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020405, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons_Statics
	{
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons_Statics::Function_MetaDataParams[] = {
		{ "Category", "Lyra" },
		{ "ModuleRelativePath", "Equipment/LyraQuickBarComponent.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_ULyraQuickBarComponent, nullptr, "UnequipWeapons", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020405, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULyraQuickBarComponent_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ULyraQuickBarComponent_ToggleWeapons, "ToggleWeapons" }, // 1692315285
		{ &Z_Construct_UFunction_ULyraQuickBarComponent_UnequipWeapons, "UnequipWeapons" }, // 659818901
	};
#if WITH_METADATA
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraQuickBarComponent>()
	{
		return ULyraQuickBarComponent::StaticClass();
	}
...
class UScriptStruct* FLyraQuickBarSlotsChangedMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraQuickBarSlotsChangedMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraQuickBarSlotsChangedMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraQuickBarSlotsChangedMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraQuickBarSlotsChangedMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraQuickBarSlotsChangedMessage>()
{
...
class UScriptStruct* FLyraQuickBarActiveIndexChangedMessage::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraQuickBarActiveIndexChangedMessage.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraQuickBarActiveIndexChangedMessage, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraQuickBarActiveIndexChangedMessage"));
	}
	return Z_Registration_Info_UScriptStruct_LyraQuickBarActiveIndexChangedMessage.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraQuickBarActiveIndexChangedMessage>()
{
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics::ScriptStructInfo[] = {
		{ FLyraQuickBarSlotsChangedMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraQuickBarSlotsChangedMessage_Statics::NewStructOps, TEXT("LyraQuickBarSlotsChangedMessage"), &Z_Registration_Info_UScriptStruct_LyraQuickBarSlotsChangedMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraQuickBarSlotsChangedMessage), 158625846U) },
		{ FLyraQuickBarActiveIndexChangedMessage::StaticStruct, Z_Construct_UScriptStruct_FLyraQuickBarActiveIndexChangedMessage_Statics::NewStructOps, TEXT("LyraQuickBarActiveIndexChangedMessage"), &Z_Registration_Info_UScriptStruct_LyraQuickBarActiveIndexChangedMessage, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLyraQuickBarActiveIndexChangedMessage), 3943204409U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraQuickBarComponent, ULyraQuickBarComponent::StaticClass, TEXT("ULyraQuickBarComponent"), &Z_Registration_Info_UClass_ULyraQuickBarComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraQuickBarComponent), 2827941757U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_4215075353(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_Equipment_LyraQuickBarComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
