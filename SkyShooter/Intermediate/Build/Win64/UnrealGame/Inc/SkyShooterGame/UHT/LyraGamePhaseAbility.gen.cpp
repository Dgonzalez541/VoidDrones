...
#include "SkyShooterGame/AbilitySystem/Phases/LyraGamePhaseAbility.h"
#include "GameplayTags/Classes/GameplayTagContainer.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeLyraGamePhaseAbility() {}
// Cross Module References
	GAMEPLAYTAGS_API UScriptStruct* Z_Construct_UScriptStruct_FGameplayTag();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraGamePhaseAbility();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraGamePhaseAbility>()
	{
		return ULyraGamePhaseAbility::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraGamePhaseAbility);
	ULyraGamePhaseAbility::~ULyraGamePhaseAbility() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Phases_LyraGamePhaseAbility_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Phases_LyraGamePhaseAbility_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraGamePhaseAbility, ULyraGamePhaseAbility::StaticClass, TEXT("ULyraGamePhaseAbility"), &Z_Registration_Info_UClass_ULyraGamePhaseAbility, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraGamePhaseAbility), 2613941213U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Phases_LyraGamePhaseAbility_h_2867091158(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Phases_LyraGamePhaseAbility_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_Phases_LyraGamePhaseAbility_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
