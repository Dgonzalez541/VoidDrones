...
#include "SkyShooterGame/AbilitySystem/LyraAbilityTagRelationshipMapping.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAbilityTagRelationshipMapping();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraAbilityTagRelationshipMapping_NoRegister();
	SKYSHOOTERGAME_API UScriptStruct* Z_Construct_UScriptStruct_FLyraAbilityTagRelationship();
...
class UScriptStruct* FLyraAbilityTagRelationship::StaticStruct()
{
	...
	{
		Z_Registration_Info_UScriptStruct_LyraAbilityTagRelationship.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FLyraAbilityTagRelationship, Z_Construct_UPackage__Script_SkyShooterGame(), TEXT("LyraAbilityTagRelationship"));
	}
	return Z_Registration_Info_UScriptStruct_LyraAbilityTagRelationship.OuterSingleton;
}
template<> SKYSHOOTERGAME_API UScriptStruct* StaticStruct<FLyraAbilityTagRelationship>()
{
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraAbilityTagRelationshipMapping>()
	{
		return ULyraAbilityTagRelationshipMapping::StaticClass();
	}
	...
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraAbilityTagRelationshipMapping, ULyraAbilityTagRelationshipMapping::StaticClass, TEXT("ULyraAbilityTagRelationshipMapping"), &Z_Registration_Info_UClass_ULyraAbilityTagRelationshipMapping, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraAbilityTagRelationshipMapping), 2736354267U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_1473954741(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_AbilitySystem_LyraAbilityTagRelationshipMapping_h_Statics::ScriptStructInfo),
		nullptr, 0);
