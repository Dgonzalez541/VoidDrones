...
#include "SkyShooterGame/UI/Weapons/LyraReticleWidgetBase.h"
...
// Cross Module References
	...
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReticleWidgetBase();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraReticleWidgetBase_NoRegister();
	SKYSHOOTERGAME_API UClass* Z_Construct_UClass_ULyraWeaponInstance_NoRegister();
...
// End Cross Module References
	...
	template<> SKYSHOOTERGAME_API UClass* StaticClass<ULyraReticleWidgetBase>()
	{
		return ULyraReticleWidgetBase::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(ULyraReticleWidgetBase);
	ULyraReticleWidgetBase::~ULyraReticleWidgetBase() {}
	struct Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_LyraReticleWidgetBase_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_LyraReticleWidgetBase_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULyraReticleWidgetBase, ULyraReticleWidgetBase::StaticClass, TEXT("ULyraReticleWidgetBase"), &Z_Registration_Info_UClass_ULyraReticleWidgetBase, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULyraReticleWidgetBase), 421343148U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_LyraReticleWidgetBase_h_3520662847(TEXT("/Script/SkyShooterGame"),
		Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_LyraReticleWidgetBase_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProjects_SkyShooter_SkyShooter_SkyShooter_Source_SkyShooterGame_UI_Weapons_LyraReticleWidgetBase_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
